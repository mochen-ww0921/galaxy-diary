 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Q_;function ny(){if(Q_)return re;Q_=1;var r=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),h=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),_=Symbol.for("react.activity"),S=Symbol.iterator;function M(U){return U===null||typeof U!="object"?null:(U=S&&U[S]||U["@@iterator"],typeof U=="function"?U:null)}var b={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},C=Object.assign,y={};function x(U,st,mt){this.props=U,this.context=st,this.refs=y,this.updater=mt||b}x.prototype.isReactComponent={},x.prototype.setState=function(U,st){if(typeof U!="object"&&typeof U!="function"&&U!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,U,st,"setState")},x.prototype.forceUpdate=function(U){this.updater.enqueueForceUpdate(this,U,"forceUpdate")};function L(){}L.prototype=x.prototype;function P(U,st,mt){this.props=U,this.context=st,this.refs=y,this.updater=mt||b}var O=P.prototype=new L;O.constructor=P,C(O,x.prototype),O.isPureReactComponent=!0;var I=Array.isArray;function F(){}var z={H:null,A:null,T:null,S:null},$=Object.prototype.hasOwnProperty;function R(U,st,mt){var At=mt.ref;return{$$typeof:r,type:U,key:st,ref:At!==void 0?At:null,props:mt}}function w(U,st){return R(U.type,st,U.props)}function B(U){return typeof U=="object"&&U!==null&&U.$$typeof===r}function K(U){var st={"=":"=0",":":"=2"};return"$"+U.replace(/[=:]/g,function(mt){return st[mt]})}var Z=/\/+/g;function ct(U,st){return typeof U=="object"&&U!==null&&U.key!=null?K(""+U.key):st.toString(36)}function it(U){switch(U.status){case"fulfilled":return U.value;case"rejected":throw U.reason;default:switch(typeof U.status=="string"?U.then(F,F):(U.status="pending",U.then(function(st){U.status==="pending"&&(U.status="fulfilled",U.value=st)},function(st){U.status==="pending"&&(U.status="rejected",U.reason=st)})),U.status){case"fulfilled":return U.value;case"rejected":throw U.reason}}throw U}function N(U,st,mt,At,Ht){var at=typeof U;(at==="undefined"||at==="boolean")&&(U=null);var W=!1;if(U===null)W=!0;else switch(at){case"bigint":case"string":case"number":W=!0;break;case"object":switch(U.$$typeof){case r:case t:W=!0;break;case g:return W=U._init,N(W(U._payload),st,mt,At,Ht)}}if(W)return Ht=Ht(U),W=At===""?"."+ct(U,0):At,I(Ht)?(mt="",W!=null&&(mt=W.replace(Z,"$&/")+"/"),N(Ht,st,mt,"",function(Ot){return Ot})):Ht!=null&&(B(Ht)&&(Ht=w(Ht,mt+(Ht.key==null||U&&U.key===Ht.key?"":(""+Ht.key).replace(Z,"$&/")+"/")+W)),st.push(Ht)),1;W=0;var vt=At===""?".":At+":";if(I(U))for(var Ut=0;Ut<U.length;Ut++)At=U[Ut],at=vt+ct(At,Ut),W+=N(At,st,mt,at,Ht);else if(Ut=M(U),typeof Ut=="function")for(U=Ut.call(U),Ut=0;!(At=U.next()).done;)At=At.value,at=vt+ct(At,Ut++),W+=N(At,st,mt,at,Ht);else if(at==="object"){if(typeof U.then=="function")return N(it(U),st,mt,At,Ht);throw st=String(U),Error("Objects are not valid as a React child (found: "+(st==="[object Object]"?"object with keys {"+Object.keys(U).join(", ")+"}":st)+"). If you meant to render a collection of children, use an array instead.")}return W}function G(U,st,mt){if(U==null)return U;var At=[],Ht=0;return N(U,At,"","",function(at){return st.call(mt,at,Ht++)}),At}function tt(U){if(U._status===-1){var st=U._result;st=st(),st.then(function(mt){(U._status===0||U._status===-1)&&(U._status=1,U._result=mt)},function(mt){(U._status===0||U._status===-1)&&(U._status=2,U._result=mt)}),U._status===-1&&(U._status=0,U._result=st)}if(U._status===1)return U._result.default;throw U._result}var yt=typeof reportError=="function"?reportError:function(U){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var st=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof U=="object"&&U!==null&&typeof U.message=="string"?String(U.message):String(U),error:U});if(!window.dispatchEvent(st))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",U);return}console.error(U)},xt={map:G,forEach:function(U,st,mt){G(U,function(){st.apply(this,arguments)},mt)},count:function(U){var st=0;return G(U,function(){st++}),st},toArray:function(U){return G(U,function(st){return st})||[]},only:function(U){if(!B(U))throw Error("React.Children.only expected to receive a single React element child.");return U}};return re.Activity=_,re.Children=xt,re.Component=x,re.Fragment=i,re.Profiler=l,re.PureComponent=P,re.StrictMode=s,re.Suspense=m,re.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=z,re.__COMPILER_RUNTIME={__proto__:null,c:function(U){return z.H.useMemoCache(U)}},re.cache=function(U){return function(){return U.apply(null,arguments)}},re.cacheSignal=function(){return null},re.cloneElement=function(U,st,mt){if(U==null)throw Error("The argument must be a React element, but you passed "+U+".");var At=C({},U.props),Ht=U.key;if(st!=null)for(at in st.key!==void 0&&(Ht=""+st.key),st)!$.call(st,at)||at==="key"||at==="__self"||at==="__source"||at==="ref"&&st.ref===void 0||(At[at]=st[at]);var at=arguments.length-2;if(at===1)At.children=mt;else if(1<at){for(var W=Array(at),vt=0;vt<at;vt++)W[vt]=arguments[vt+2];At.children=W}return R(U.type,Ht,At)},re.createContext=function(U){return U={$$typeof:h,_currentValue:U,_currentValue2:U,_threadCount:0,Provider:null,Consumer:null},U.Provider=U,U.Consumer={$$typeof:u,_context:U},U},re.createElement=function(U,st,mt){var At,Ht={},at=null;if(st!=null)for(At in st.key!==void 0&&(at=""+st.key),st)$.call(st,At)&&At!=="key"&&At!=="__self"&&At!=="__source"&&(Ht[At]=st[At]);var W=arguments.length-2;if(W===1)Ht.children=mt;else if(1<W){for(var vt=Array(W),Ut=0;Ut<W;Ut++)vt[Ut]=arguments[Ut+2];Ht.children=vt}if(U&&U.defaultProps)for(At in W=U.defaultProps,W)Ht[At]===void 0&&(Ht[At]=W[At]);return R(U,at,Ht)},re.createRef=function(){return{current:null}},re.forwardRef=function(U){return{$$typeof:d,render:U}},re.isValidElement=B,re.lazy=function(U){return{$$typeof:g,_payload:{_status:-1,_result:U},_init:tt}},re.memo=function(U,st){return{$$typeof:p,type:U,compare:st===void 0?null:st}},re.startTransition=function(U){var st=z.T,mt={};z.T=mt;try{var At=U(),Ht=z.S;Ht!==null&&Ht(mt,At),typeof At=="object"&&At!==null&&typeof At.then=="function"&&At.then(F,yt)}catch(at){yt(at)}finally{st!==null&&mt.types!==null&&(st.types=mt.types),z.T=st}},re.unstable_useCacheRefresh=function(){return z.H.useCacheRefresh()},re.use=function(U){return z.H.use(U)},re.useActionState=function(U,st,mt){return z.H.useActionState(U,st,mt)},re.useCallback=function(U,st){return z.H.useCallback(U,st)},re.useContext=function(U){return z.H.useContext(U)},re.useDebugValue=function(){},re.useDeferredValue=function(U,st){return z.H.useDeferredValue(U,st)},re.useEffect=function(U,st){return z.H.useEffect(U,st)},re.useEffectEvent=function(U){return z.H.useEffectEvent(U)},re.useId=function(){return z.H.useId()},re.useImperativeHandle=function(U,st,mt){return z.H.useImperativeHandle(U,st,mt)},re.useInsertionEffect=function(U,st){return z.H.useInsertionEffect(U,st)},re.useLayoutEffect=function(U,st){return z.H.useLayoutEffect(U,st)},re.useMemo=function(U,st){return z.H.useMemo(U,st)},re.useOptimistic=function(U,st){return z.H.useOptimistic(U,st)},re.useReducer=function(U,st,mt){return z.H.useReducer(U,st,mt)},re.useRef=function(U){return z.H.useRef(U)},re.useState=function(U){return z.H.useState(U)},re.useSyncExternalStore=function(U,st,mt){return z.H.useSyncExternalStore(U,st,mt)},re.useTransition=function(){return z.H.useTransition()},re.version="19.2.3",re}var J_;function ep(){return J_||(J_=1,Sh.exports=ny()),Sh.exports}var le=ep();const iy=uv(le);var yh={exports:{}},Yo={},Mh={exports:{}},Eh={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var $_;function ay(){return $_||($_=1,(function(r){function t(N,G){var tt=N.length;N.push(G);t:for(;0<tt;){var yt=tt-1>>>1,xt=N[yt];if(0<l(xt,G))N[yt]=G,N[tt]=xt,tt=yt;else break t}}function i(N){return N.length===0?null:N[0]}function s(N){if(N.length===0)return null;var G=N[0],tt=N.pop();if(tt!==G){N[0]=tt;t:for(var yt=0,xt=N.length,U=xt>>>1;yt<U;){var st=2*(yt+1)-1,mt=N[st],At=st+1,Ht=N[At];if(0>l(mt,tt))At<xt&&0>l(Ht,mt)?(N[yt]=Ht,N[At]=tt,yt=At):(N[yt]=mt,N[st]=tt,yt=st);else if(At<xt&&0>l(Ht,tt))N[yt]=Ht,N[At]=tt,yt=At;else break t}}return G}function l(N,G){var tt=N.sortIndex-G.sortIndex;return tt!==0?tt:N.id-G.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;r.unstable_now=function(){return u.now()}}else{var h=Date,d=h.now();r.unstable_now=function(){return h.now()-d}}var m=[],p=[],g=1,_=null,S=3,M=!1,b=!1,C=!1,y=!1,x=typeof setTimeout=="function"?setTimeout:null,L=typeof clearTimeout=="function"?clearTimeout:null,P=typeof setImmediate<"u"?setImmediate:null;function O(N){for(var G=i(p);G!==null;){if(G.callback===null)s(p);else if(G.startTime<=N)s(p),G.sortIndex=G.expirationTime,t(m,G);else break;G=i(p)}}function I(N){if(C=!1,O(N),!b)if(i(m)!==null)b=!0,F||(F=!0,K());else{var G=i(p);G!==null&&it(I,G.startTime-N)}}var F=!1,z=-1,$=5,R=-1;function w(){return y?!0:!(r.unstable_now()-R<$)}function B(){if(y=!1,F){var N=r.unstable_now();R=N;var G=!0;try{t:{b=!1,C&&(C=!1,L(z),z=-1),M=!0;var tt=S;try{e:{for(O(N),_=i(m);_!==null&&!(_.expirationTime>N&&w());){var yt=_.callback;if(typeof yt=="function"){_.callback=null,S=_.priorityLevel;var xt=yt(_.expirationTime<=N);if(N=r.unstable_now(),typeof xt=="function"){_.callback=xt,O(N),G=!0;break e}_===i(m)&&s(m),O(N)}else s(m);_=i(m)}if(_!==null)G=!0;else{var U=i(p);U!==null&&it(I,U.startTime-N),G=!1}}break t}finally{_=null,S=tt,M=!1}G=void 0}}finally{G?K():F=!1}}}var K;if(typeof P=="function")K=function(){P(B)};else if(typeof MessageChannel<"u"){var Z=new MessageChannel,ct=Z.port2;Z.port1.onmessage=B,K=function(){ct.postMessage(null)}}else K=function(){x(B,0)};function it(N,G){z=x(function(){N(r.unstable_now())},G)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(N){N.callback=null},r.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):$=0<N?Math.floor(1e3/N):5},r.unstable_getCurrentPriorityLevel=function(){return S},r.unstable_next=function(N){switch(S){case 1:case 2:case 3:var G=3;break;default:G=S}var tt=S;S=G;try{return N()}finally{S=tt}},r.unstable_requestPaint=function(){y=!0},r.unstable_runWithPriority=function(N,G){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var tt=S;S=N;try{return G()}finally{S=tt}},r.unstable_scheduleCallback=function(N,G,tt){var yt=r.unstable_now();switch(typeof tt=="object"&&tt!==null?(tt=tt.delay,tt=typeof tt=="number"&&0<tt?yt+tt:yt):tt=yt,N){case 1:var xt=-1;break;case 2:xt=250;break;case 5:xt=1073741823;break;case 4:xt=1e4;break;default:xt=5e3}return xt=tt+xt,N={id:g++,callback:G,priorityLevel:N,startTime:tt,expirationTime:xt,sortIndex:-1},tt>yt?(N.sortIndex=tt,t(p,N),i(m)===null&&N===i(p)&&(C?(L(z),z=-1):C=!0,it(I,tt-yt))):(N.sortIndex=xt,t(m,N),b||M||(b=!0,F||(F=!0,K()))),N},r.unstable_shouldYield=w,r.unstable_wrapCallback=function(N){var G=S;return function(){var tt=S;S=G;try{return N.apply(this,arguments)}finally{S=tt}}}})(Eh)),Eh}var tg;function sy(){return tg||(tg=1,Mh.exports=ay()),Mh.exports}var bh={exports:{}},Ln={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ig;function ly(){if(ig)return Yo;ig=1;var r=sy(),t=ep(),i=oy();function s(e){var n="https://react.dev/errors/"+e;if(1<arguments.length){n+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)n+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+e+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function l(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function u(e){var n=e,a=e;if(e.alternate)for(;n.return;)n=n.return;else{e=n;do n=e,(n.flags&4098)!==0&&(a=n.return),e=n.return;while(e)}return n.tag===3?a:null}function h(e){if(e.tag===13){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function d(e){if(e.tag===31){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function m(e){if(u(e)!==e)throw Error(s(188))}function p(e){var n=e.alternate;if(!n){if(n=u(e),n===null)throw Error(s(188));return n!==e?null:e}for(var a=e,o=n;;){var c=a.return;if(c===null)break;var f=c.alternate;if(f===null){if(o=c.return,o!==null){a=o;continue}break}if(c.child===f.child){for(f=c.child;f;){if(f===a)return m(c),e;if(f===o)return m(c),n;f=f.sibling}throw Error(s(188))}if(a.return!==o.return)a=c,o=f;else{for(var v=!1,T=c.child;T;){if(T===a){v=!0,a=c,o=f;break}if(T===o){v=!0,o=c,a=f;break}T=T.sibling}if(!v){for(T=f.child;T;){if(T===a){v=!0,a=f,o=c;break}if(T===o){v=!0,o=f,a=c;break}T=T.sibling}if(!v)throw Error(s(189))}}if(a.alternate!==o)throw Error(s(190))}if(a.tag!==3)throw Error(s(188));return a.stateNode.current===a?e:n}function g(e){var n=e.tag;if(n===5||n===26||n===27||n===6)return e;for(e=e.child;e!==null;){if(n=g(e),n!==null)return n;e=e.sibling}return null}var _=Object.assign,S=Symbol.for("react.element"),M=Symbol.for("react.transitional.element"),b=Symbol.for("react.portal"),C=Symbol.for("react.fragment"),y=Symbol.for("react.strict_mode"),x=Symbol.for("react.profiler"),L=Symbol.for("react.consumer"),P=Symbol.for("react.context"),O=Symbol.for("react.forward_ref"),I=Symbol.for("react.suspense"),F=Symbol.for("react.suspense_list"),z=Symbol.for("react.memo"),$=Symbol.for("react.lazy"),R=Symbol.for("react.activity"),w=Symbol.for("react.memo_cache_sentinel"),B=Symbol.iterator;function K(e){return e===null||typeof e!="object"?null:(e=B&&e[B]||e["@@iterator"],typeof e=="function"?e:null)}var Z=Symbol.for("react.client.reference");function ct(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===Z?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case C:return"Fragment";case x:return"Profiler";case y:return"StrictMode";case I:return"Suspense";case F:return"SuspenseList";case R:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case b:return"Portal";case P:return e.displayName||"Context";case L:return(e._context.displayName||"Context")+".Consumer";case O:var n=e.render;return e=e.displayName,e||(e=n.displayName||n.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case z:return n=e.displayName||null,n!==null?n:ct(e.type)||"Memo";case $:n=e._payload,e=e._init;try{return ct(e(n))}catch{}}return null}var it=Array.isArray,N=t.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,G=i.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,tt={pending:!1,data:null,method:null,action:null},yt=[],xt=-1;function U(e){return{current:e}}function st(e){0>xt||(e.current=yt[xt],yt[xt]=null,xt--)}function mt(e,n){xt++,yt[xt]=e.current,e.current=n}var At=U(null),Ht=U(null),at=U(null),W=U(null);function vt(e,n){switch(mt(at,n),mt(Ht,e),mt(At,null),n.nodeType){case 9:case 11:e=(e=n.documentElement)&&(e=e.namespaceURI)?v_(e):0;break;default:if(e=n.tagName,n=n.namespaceURI)n=v_(n),e=x_(n,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}st(At),mt(At,e)}function Ut(){st(At),st(Ht),st(at)}function Ot(e){e.memoizedState!==null&&mt(W,e);var n=At.current,a=x_(n,e.type);n!==a&&(mt(Ht,e),mt(At,a))}function ce(e){Ht.current===e&&(st(At),st(Ht)),W.current===e&&(st(W),Go._currentValue=tt)}var tn,xe;function _e(e){if(tn===void 0)try{throw Error()}catch(a){var n=a.stack.trim().match(/\n( *(at )?)/);tn=n&&n[1]||"",xe=-1<a.stack.indexOf(`
    at`)?" (<anonymous>)":-1<a.stack.indexOf("@")?"@unknown:0:0":""}return`
`+tn+e+xe}var we=!1;function oe(e,n){if(!e||we)return"";we=!0;var a=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{var o={DetermineComponentFrameRoot:function(){try{if(n){var _t=function(){throw Error()};if(Object.defineProperty(_t.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(_t,[])}catch(ut){var ot=ut}Reflect.construct(e,[],_t)}else{try{_t.call()}catch(ut){ot=ut}e.call(_t.prototype)}}else{try{throw Error()}catch(ut){ot=ut}(_t=e())&&typeof _t.catch=="function"&&_t.catch(function(){})}}catch(ut){if(ut&&ot&&typeof ut.stack=="string")return[ut.stack,ot.stack]}return[null,null]}};o.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot";var c=Object.getOwnPropertyDescriptor(o.DetermineComponentFrameRoot,"name");c&&c.configurable&&Object.defineProperty(o.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});var f=o.DetermineComponentFrameRoot(),v=f[0],T=f[1];if(v&&T){var H=v.split(`
`),nt=T.split(`
`);for(c=o=0;o<H.length&&!H[o].includes("DetermineComponentFrameRoot");)o++;for(;c<nt.length&&!nt[c].includes("DetermineComponentFrameRoot");)c++;if(o===H.length||c===nt.length)for(o=H.length-1,c=nt.length-1;1<=o&&0<=c&&H[o]!==nt[c];)c--;for(;1<=o&&0<=c;o--,c--)if(H[o]!==nt[c]){if(o!==1||c!==1)do if(o--,c--,0>c||H[o]!==nt[c]){var ht=`
...
`].filter(il).join(`
`)),h=Jd(h),h=Qg(h,i),h=Jg(h,i),d=Jd(d),d=Qg(d,i),d=Jg(d,i),h=$g(h),d=$g(d),i.isRawShaderMaterial!==!0&&(L=`#version 300 es
...
`)+`
`+x);const P=L+y+h,O=L+x+d,I=jg(l,l.VERTEX_SHADER,P),F=jg(l,l.FRAGMENT_SHADER,O);l.attachShader(C,I),l.attachShader(C,F),i.index0AttributeName!==void 0?l.bindAttribLocation(C,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(C,0,"position"),l.linkProgram(C);function z(B){if(r.debug.checkShaderErrors){const K=l.getProgramInfoLog(C)||"",Z=l.getShaderInfoLog(I)||"",ct=l.getShaderInfoLog(F)||"",it=K.trim(),N=Z.trim(),G=ct.trim();let tt=!0,yt=!0;if(l.getProgramParameter(C,l.LINK_STATUS)===!1)if(tt=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(l,C,I,F);else{const xt=Kg(l,I,"vertex"),U=Kg(l,F,"fragment");be("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(C,l.VALIDATE_STATUS)+`
...
Program Info Log: `+it+`
`+xt+`
`+U)}else it!==""?ae("WebGLProgram: Program Info Log:",it):(N===""||G==="")&&(yt=!1);yt&&(B.diagnostics={runnable:tt,programLog:it,vertexShader:{log:N,prefix:y},fragmentShader:{log:G,prefix:x}})}l.deleteShader(I),l.deleteShader(F),$=new nc(l,C),R=K1(l,C)}let $;this.getUniforms=function(){return $===void 0&&z(this),$};let R;this.getAttributes=function(){return R===void 0&&z(this),R};let w=i.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return w===!1&&(w=l.getProgramParameter(C,H1)),w},this.destroy=function(){s.releaseStatesOfProgram(this),l.deleteProgram(C),this.program=void 0},this.type=i.shaderType,this.name=i.shaderName,this.id=G1++,this.cacheKey=t,this.usedTimes=1,this.program=C,this.vertexShader=I,this.fragmentShader=F,this}let hA=0;class dA{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t){const i=t.vertexShader,s=t.fragmentShader,l=this._getShaderStage(i),u=this._getShaderStage(s),h=this._getShaderCacheForMaterial(t);return h.has(l)===!1&&(h.add(l),l.usedTimes++),h.has(u)===!1&&(h.add(u),u.usedTimes++),this}remove(t){const i=this.materialCache.get(t);for(const s of i)s.usedTimes--,s.usedTimes===0&&this.shaderCache.delete(s.code);return this.materialCache.delete(t),this}getVertexShaderID(t){return this._getShaderStage(t.vertexShader).id}getFragmentShaderID(t){return this._getShaderStage(t.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){const i=this.materialCache;let s=i.get(t);return s===void 0&&(s=new Set,i.set(t,s)),s}_getShaderStage(t){const i=this.shaderCache;let s=i.get(t);return s===void 0&&(s=new pA(t),i.set(t,s)),s}}class pA{constructor(t){this.id=hA++,this.code=t,this.usedTimes=0}}function mA(r,t,i,s,l,u,h){const d=new dp,m=new dA,p=new Set,g=[],_=new Map,S=l.logarithmicDepthBuffer;let M=l.precision;const b={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function C(R){return p.add(R),R===0?"uv":`uv${R}`}function y(R,w,B,K,Z){const ct=K.fog,it=Z.geometry,N=R.isMeshStandardMaterial?K.environment:null,G=(R.isMeshStandardMaterial?i:t).get(R.envMap||N),tt=G&&G.mapping===uc?G.image.height:null,yt=b[R.type];R.precision!==null&&(M=l.getMaxPrecision(R.precision),M!==R.precision&&ae("WebGLProgram.getParameters:",R.precision,"not supported, using",M,"instead."));const xt=it.morphAttributes.position||it.morphAttributes.normal||it.morphAttributes.color,U=xt!==void 0?xt.length:0;let st=0;it.morphAttributes.position!==void 0&&(st=1),it.morphAttributes.normal!==void 0&&(st=2),it.morphAttributes.color!==void 0&&(st=3);let mt,At,Ht,at;if(yt){const Te=Hi[yt];mt=Te.vertexShader,At=Te.fragmentShader}else mt=R.vertexShader,At=R.fragmentShader,m.update(R),Ht=m.getVertexShaderID(R),at=m.getFragmentShaderID(R);const W=r.getRenderTarget(),vt=r.state.buffers.depth.getReversed(),Ut=Z.isInstancedMesh===!0,Ot=Z.isBatchedMesh===!0,ce=!!R.map,tn=!!R.matcap,xe=!!G,_e=!!R.aoMap,we=!!R.lightMap,oe=!!R.bumpMap,en=!!R.normalMap,V=!!R.displacementMap,Ke=!!R.emissiveMap,Ee=!!R.metalnessMap,Le=!!R.roughnessMap,qt=R.anisotropy>0,D=R.clearcoat>0,E=R.dispersion>0,Y=R.iridescence>0,dt=R.sheen>0,St=R.transmission>0,ft=qt&&!!R.anisotropyMap,Zt=D&&!!R.clearcoatMap,wt=D&&!!R.clearcoatNormalMap,Xt=D&&!!R.clearcoatRoughnessMap,ee=Y&&!!R.iridescenceMap,Et=Y&&!!R.iridescenceThicknessMap,bt=dt&&!!R.sheenColorMap,Bt=dt&&!!R.sheenRoughnessMap,It=!!R.specularMap,Dt=!!R.specularColorMap,fe=!!R.specularIntensityMap,X=St&&!!R.transmissionMap,Lt=St&&!!R.thicknessMap,Tt=!!R.gradientMap,Ft=!!R.alphaMap,Mt=R.alphaTest>0,gt=!!R.alphaHash,Rt=!!R.extensions;let ie=ki;R.toneMapped&&(W===null||W.isXRRenderTarget===!0)&&(ie=r.toneMapping);const ze={shaderID:yt,shaderType:R.type,shaderName:R.name,vertexShader:mt,fragmentShader:At,defines:R.defines,customVertexShaderID:Ht,customFragmentShaderID:at,isRawShaderMaterial:R.isRawShaderMaterial===!0,glslVersion:R.glslVersion,precision:M,batching:Ot,batchingColor:Ot&&Z._colorsTexture!==null,instancing:Ut,instancingColor:Ut&&Z.instanceColor!==null,instancingMorph:Ut&&Z.morphTexture!==null,outputColorSpace:W===null?r.outputColorSpace:W.isXRRenderTarget===!0?W.texture.colorSpace:jr,alphaToCoverage:!!R.alphaToCoverage,map:ce,matcap:tn,envMap:xe,envMapMode:xe&&G.mapping,envMapCubeUVHeight:tt,aoMap:_e,lightMap:we,bumpMap:oe,normalMap:en,displacementMap:V,emissiveMap:Ke,normalMapObjectSpace:en&&R.normalMapType===Fy,normalMapTangentSpace:en&&R.normalMapType===Iy,metalnessMap:Ee,roughnessMap:Le,anisotropy:qt,anisotropyMap:ft,clearcoat:D,clearcoatMap:Zt,clearcoatNormalMap:wt,clearcoatRoughnessMap:Xt,dispersion:E,iridescence:Y,iridescenceMap:ee,iridescenceThicknessMap:Et,sheen:dt,sheenColorMap:bt,sheenRoughnessMap:Bt,specularMap:It,specularColorMap:Dt,specularIntensityMap:fe,transmission:St,transmissionMap:X,thicknessMap:Lt,gradientMap:Tt,opaque:R.transparent===!1&&R.blending===kr&&R.alphaToCoverage===!1,alphaMap:Ft,alphaTest:Mt,alphaHash:gt,combine:R.combine,mapUv:ce&&C(R.map.channel),aoMapUv:_e&&C(R.aoMap.channel),lightMapUv:we&&C(R.lightMap.channel),bumpMapUv:oe&&C(R.bumpMap.channel),normalMapUv:en&&C(R.normalMap.channel),displacementMapUv:V&&C(R.displacementMap.channel),emissiveMapUv:Ke&&C(R.emissiveMap.channel),metalnessMapUv:Ee&&C(R.metalnessMap.channel),roughnessMapUv:Le&&C(R.roughnessMap.channel),anisotropyMapUv:ft&&C(R.anisotropyMap.channel),clearcoatMapUv:Zt&&C(R.clearcoatMap.channel),clearcoatNormalMapUv:wt&&C(R.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Xt&&C(R.clearcoatRoughnessMap.channel),iridescenceMapUv:ee&&C(R.iridescenceMap.channel),iridescenceThicknessMapUv:Et&&C(R.iridescenceThicknessMap.channel),sheenColorMapUv:bt&&C(R.sheenColorMap.channel),sheenRoughnessMapUv:Bt&&C(R.sheenRoughnessMap.channel),specularMapUv:It&&C(R.specularMap.channel),specularColorMapUv:Dt&&C(R.specularColorMap.channel),specularIntensityMapUv:fe&&C(R.specularIntensityMap.channel),transmissionMapUv:X&&C(R.transmissionMap.channel),thicknessMapUv:Lt&&C(R.thicknessMap.channel),alphaMapUv:Ft&&C(R.alphaMap.channel),vertexTangents:!!it.attributes.tangent&&(en||qt),vertexColors:R.vertexColors,vertexAlphas:R.vertexColors===!0&&!!it.attributes.color&&it.attributes.color.itemSize===4,pointsUvs:Z.isPoints===!0&&!!it.attributes.uv&&(ce||Ft),fog:!!ct,useFog:R.fog===!0,fogExp2:!!ct&&ct.isFogExp2,flatShading:R.flatShading===!0&&R.wireframe===!1,sizeAttenuation:R.sizeAttenuation===!0,logarithmicDepthBuffer:S,reversedDepthBuffer:vt,skinning:Z.isSkinnedMesh===!0,morphTargets:it.morphAttributes.position!==void 0,morphNormals:it.morphAttributes.normal!==void 0,morphColors:it.morphAttributes.color!==void 0,morphTargetsCount:U,morphTextureStride:st,numDirLights:w.directional.length,numPointLights:w.point.length,numSpotLights:w.spot.length,numSpotLightMaps:w.spotLightMap.length,numRectAreaLights:w.rectArea.length,numHemiLights:w.hemi.length,numDirLightShadows:w.directionalShadowMap.length,numPointLightShadows:w.pointShadowMap.length,numSpotLightShadows:w.spotShadowMap.length,numSpotLightShadowsWithMaps:w.numSpotLightShadowsWithMaps,numLightProbes:w.numLightProbes,numClippingPlanes:h.numPlanes,numClipIntersection:h.numIntersection,dithering:R.dithering,shadowMapEnabled:r.shadowMap.enabled&&B.length>0,shadowMapType:r.shadowMap.type,toneMapping:ie,decodeVideoTexture:ce&&R.map.isVideoTexture===!0&&Ae.getTransfer(R.map.colorSpace)===He,decodeVideoTextureEmissive:Ke&&R.emissiveMap.isVideoTexture===!0&&Ae.getTransfer(R.emissiveMap.colorSpace)===He,premultipliedAlpha:R.premultipliedAlpha,doubleSided:R.side===va,flipSided:R.side===Zn,useDepthPacking:R.depthPacking>=0,depthPacking:R.depthPacking||0,index0AttributeName:R.index0AttributeName,extensionClipCullDistance:Rt&&R.extensions.clipCullDistance===!0&&s.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Rt&&R.extensions.multiDraw===!0||Ot)&&s.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:s.has("KHR_parallel_shader_compile"),customProgramCacheKey:R.customProgramCacheKey()};return ze.vertexUv1s=p.has(1),ze.vertexUv2s=p.has(2),ze.vertexUv3s=p.has(3),p.clear(),ze}function x(R){const w=[];if(R.shaderID?w.push(R.shaderID):(w.push(R.customVertexShaderID),w.push(R.customFragmentShaderID)),R.defines!==void 0)for(const B in R.defines)w.push(B),w.push(R.defines[B]);return R.isRawShaderMaterial===!1&&(L(w,R),P(w,R),w.push(r.outputColorSpace)),w.push(R.customProgramCacheKey),w.join()}function L(R,w){R.push(w.precision),R.push(w.outputColorSpace),R.push(w.envMapMode),R.push(w.envMapCubeUVHeight),R.push(w.mapUv),R.push(w.alphaMapUv),R.push(w.lightMapUv),R.push(w.aoMapUv),R.push(w.bumpMapUv),R.push(w.normalMapUv),R.push(w.displacementMapUv),R.push(w.emissiveMapUv),R.push(w.metalnessMapUv),R.push(w.roughnessMapUv),R.push(w.anisotropyMapUv),R.push(w.clearcoatMapUv),R.push(w.clearcoatNormalMapUv),R.push(w.clearcoatRoughnessMapUv),R.push(w.iridescenceMapUv),R.push(w.iridescenceThicknessMapUv),R.push(w.sheenColorMapUv),R.push(w.sheenRoughnessMapUv),R.push(w.specularMapUv),R.push(w.specularColorMapUv),R.push(w.specularIntensityMapUv),R.push(w.transmissionMapUv),R.push(w.thicknessMapUv),R.push(w.combine),R.push(w.fogExp2),R.push(w.sizeAttenuation),R.push(w.morphTargetsCount),R.push(w.morphAttributeCount),R.push(w.numDirLights),R.push(w.numPointLights),R.push(w.numSpotLights),R.push(w.numSpotLightMaps),R.push(w.numHemiLights),R.push(w.numRectAreaLights),R.push(w.numDirLightShadows),R.push(w.numPointLightShadows),R.push(w.numSpotLightShadows),R.push(w.numSpotLightShadowsWithMaps),R.push(w.numLightProbes),R.push(w.shadowMapType),R.push(w.toneMapping),R.push(w.numClippingPlanes),R.push(w.numClipIntersection),R.push(w.depthPacking)}function P(R,w){d.disableAll(),w.instancing&&d.enable(0),w.instancingColor&&d.enable(1),w.instancingMorph&&d.enable(2),w.matcap&&d.enable(3),w.envMap&&d.enable(4),w.normalMapObjectSpace&&d.enable(5),w.normalMapTangentSpace&&d.enable(6),w.clearcoat&&d.enable(7),w.iridescence&&d.enable(8),w.alphaTest&&d.enable(9),w.vertexColors&&d.enable(10),w.vertexAlphas&&d.enable(11),w.vertexUv1s&&d.enable(12),w.vertexUv2s&&d.enable(13),w.vertexUv3s&&d.enable(14),w.vertexTangents&&d.enable(15),w.anisotropy&&d.enable(16),w.alphaHash&&d.enable(17),w.batching&&d.enable(18),w.dispersion&&d.enable(19),w.batchingColor&&d.enable(20),w.gradientMap&&d.enable(21),R.push(d.mask),d.disableAll(),w.fog&&d.enable(0),w.useFog&&d.enable(1),w.flatShading&&d.enable(2),w.logarithmicDepthBuffer&&d.enable(3),w.reversedDepthBuffer&&d.enable(4),w.skinning&&d.enable(5),w.morphTargets&&d.enable(6),w.morphNormals&&d.enable(7),w.morphColors&&d.enable(8),w.premultipliedAlpha&&d.enable(9),w.shadowMapEnabled&&d.enable(10),w.doubleSided&&d.enable(11),w.flipSided&&d.enable(12),w.useDepthPacking&&d.enable(13),w.dithering&&d.enable(14),w.transmission&&d.enable(15),w.sheen&&d.enable(16),w.opaque&&d.enable(17),w.pointsUvs&&d.enable(18),w.decodeVideoTexture&&d.enable(19),w.decodeVideoTextureEmissive&&d.enable(20),w.alphaToCoverage&&d.enable(21),R.push(d.mask)}function O(R){const w=b[R.type];let B;if(w){const K=Hi[w];B=RM.clone(K.uniforms)}else B=R.uniforms;return B}function I(R,w){let B=_.get(w);return B!==void 0?++B.usedTimes:(B=new fA(r,w,R,u),g.push(B),_.set(w,B)),B}function F(R){if(--R.usedTimes===0){const w=g.indexOf(R);g[w]=g[g.length-1],g.pop(),_.delete(R.cacheKey),R.destroy()}}function z(R){m.remove(R)}function $(){m.dispose()}return{getParameters:y,getProgramCacheKey:x,getUniforms:O,acquireProgram:I,releaseProgram:F,releaseShaderCache:z,programs:g,dispose:$}}function _A(){let r=new WeakMap;function t(h){return r.has(h)}function i(h){let d=r.get(h);return d===void 0&&(d={},r.set(h,d)),d}function s(h){r.delete(h)}function l(h,d,m){r.get(h)[d]=m}function u(){r=new WeakMap}return{has:t,get:i,remove:s,update:l,dispose:u}}function gA(r,t){return r.groupOrder!==t.groupOrder?r.groupOrder-t.groupOrder:r.renderOrder!==t.renderOrder?r.renderOrder-t.renderOrder:r.material.id!==t.material.id?r.material.id-t.material.id:r.z!==t.z?r.z-t.z:r.id-t.id}function ev(r,t){return r.groupOrder!==t.groupOrder?r.groupOrder-t.groupOrder:r.renderOrder!==t.renderOrder?r.renderOrder-t.renderOrder:r.z!==t.z?t.z-r.z:r.id-t.id}function nv(){const r=[];let t=0;const i=[],s=[],l=[];function u(){t=0,i.length=0,s.length=0,l.length=0}function h(_,S,M,b,C,y){let x=r[t];return x===void 0?(x={id:_.id,object:_,geometry:S,material:M,groupOrder:b,renderOrder:_.renderOrder,z:C,group:y},r[t]=x):(x.id=_.id,x.object=_,x.geometry=S,x.material=M,x.groupOrder=b,x.renderOrder=_.renderOrder,x.z=C,x.group=y),t++,x}function d(_,S,M,b,C,y){const x=h(_,S,M,b,C,y);M.transmission>0?s.push(x):M.transparent===!0?l.push(x):i.push(x)}function m(_,S,M,b,C,y){const x=h(_,S,M,b,C,y);M.transmission>0?s.unshift(x):M.transparent===!0?l.unshift(x):i.unshift(x)}function p(_,S){i.length>1&&i.sort(_||gA),s.length>1&&s.sort(S||ev),l.length>1&&l.sort(S||ev)}function g(){for(let _=t,S=r.length;_<S;_++){const M=r[_];if(M.id===null)break;M.id=null,M.object=null,M.geometry=null,M.material=null,M.group=null}}return{opaque:i,transmissive:s,transparent:l,init:u,push:d,unshift:m,finish:g,sort:p}}function vA(){let r=new WeakMap;function t(s,l){const u=r.get(s);let h;return u===void 0?(h=new nv,r.set(s,[h])):l>=u.length?(h=new nv,u.push(h)):h=u[l],h}function i(){r=new WeakMap}return{get:t,dispose:i}}function xA(){const r={};return{get:function(t){if(r[t.id]!==void 0)return r[t.id];let i;switch(t.type){case"DirectionalLight":i={direction:new J,color:new Pe};break;case"SpotLight":i={position:new J,direction:new J,color:new Pe,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":i={position:new J,color:new Pe,distance:0,decay:0};break;case"HemisphereLight":i={direction:new J,skyColor:new Pe,groundColor:new Pe};break;case"RectAreaLight":i={color:new Pe,position:new J,halfWidth:new J,halfHeight:new J};break}return r[t.id]=i,i}}}function SA(){const r={};return{get:function(t){if(r[t.id]!==void 0)return r[t.id];let i;switch(t.type){case"DirectionalLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ne};break;case"SpotLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ne};break;case"PointLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ne,shadowCameraNear:1,shadowCameraFar:1e3};break}return r[t.id]=i,i}}}let yA=0;function MA(r,t){return(t.castShadow?2:0)-(r.castShadow?2:0)+(t.map?1:0)-(r.map?1:0)}function EA(r){const t=new xA,i=SA(),s={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let p=0;p<9;p++)s.probe.push(new J);const l=new J,u=new $e,h=new $e;function d(p){let g=0,_=0,S=0;for(let R=0;R<9;R++)s.probe[R].set(0,0,0);let M=0,b=0,C=0,y=0,x=0,L=0,P=0,O=0,I=0,F=0,z=0;p.sort(MA);for(let R=0,w=p.length;R<w;R++){const B=p[R],K=B.color,Z=B.intensity,ct=B.distance;let it=null;if(B.shadow&&B.shadow.map&&(B.shadow.map.texture.format===qr?it=B.shadow.map.texture:it=B.shadow.map.depthTexture||B.shadow.map.texture),B.isAmbientLight)g+=K.r*Z,_+=K.g*Z,S+=K.b*Z;else if(B.isLightProbe){for(let N=0;N<9;N++)s.probe[N].addScaledVector(B.sh.coefficients[N],Z);z++}else if(B.isDirectionalLight){const N=t.get(B);if(N.color.copy(B.color).multiplyScalar(B.intensity),B.castShadow){const G=B.shadow,tt=i.get(B);tt.shadowIntensity=G.intensity,tt.shadowBias=G.bias,tt.shadowNormalBias=G.normalBias,tt.shadowRadius=G.radius,tt.shadowMapSize=G.mapSize,s.directionalShadow[M]=tt,s.directionalShadowMap[M]=it,s.directionalShadowMatrix[M]=B.shadow.matrix,L++}s.directional[M]=N,M++}else if(B.isSpotLight){const N=t.get(B);N.position.setFromMatrixPosition(B.matrixWorld),N.color.copy(K).multiplyScalar(Z),N.distance=ct,N.coneCos=Math.cos(B.angle),N.penumbraCos=Math.cos(B.angle*(1-B.penumbra)),N.decay=B.decay,s.spot[C]=N;const G=B.shadow;if(B.map&&(s.spotLightMap[I]=B.map,I++,G.updateMatrices(B),B.castShadow&&F++),s.spotLightMatrix[C]=G.matrix,B.castShadow){const tt=i.get(B);tt.shadowIntensity=G.intensity,tt.shadowBias=G.bias,tt.shadowNormalBias=G.normalBias,tt.shadowRadius=G.radius,tt.shadowMapSize=G.mapSize,s.spotShadow[C]=tt,s.spotShadowMap[C]=it,O++}C++}else if(B.isRectAreaLight){const N=t.get(B);N.color.copy(K).multiplyScalar(Z),N.halfWidth.set(B.width*.5,0,0),N.halfHeight.set(0,B.height*.5,0),s.rectArea[y]=N,y++}else if(B.isPointLight){const N=t.get(B);if(N.color.copy(B.color).multiplyScalar(B.intensity),N.distance=B.distance,N.decay=B.decay,B.castShadow){const G=B.shadow,tt=i.get(B);tt.shadowIntensity=G.intensity,tt.shadowBias=G.bias,tt.shadowNormalBias=G.normalBias,tt.shadowRadius=G.radius,tt.shadowMapSize=G.mapSize,tt.shadowCameraNear=G.camera.near,tt.shadowCameraFar=G.camera.far,s.pointShadow[b]=tt,s.pointShadowMap[b]=it,s.pointShadowMatrix[b]=B.shadow.matrix,P++}s.point[b]=N,b++}else if(B.isHemisphereLight){const N=t.get(B);N.skyColor.copy(B.color).multiplyScalar(Z),N.groundColor.copy(B.groundColor).multiplyScalar(Z),s.hemi[x]=N,x++}}y>0&&(r.has("OES_texture_float_linear")===!0?(s.rectAreaLTC1=zt.LTC_FLOAT_1,s.rectAreaLTC2=zt.LTC_FLOAT_2):(s.rectAreaLTC1=zt.LTC_HALF_1,s.rectAreaLTC2=zt.LTC_HALF_2)),s.ambient[0]=g,s.ambient[1]=_,s.ambient[2]=S;const $=s.hash;($.directionalLength!==M||$.pointLength!==b||$.spotLength!==C||$.rectAreaLength!==y||$.hemiLength!==x||$.numDirectionalShadows!==L||$.numPointShadows!==P||$.numSpotShadows!==O||$.numSpotMaps!==I||$.numLightProbes!==z)&&(s.directional.length=M,s.spot.length=C,s.rectArea.length=y,s.point.length=b,s.hemi.length=x,s.directionalShadow.length=L,s.directionalShadowMap.length=L,s.pointShadow.length=P,s.pointShadowMap.length=P,s.spotShadow.length=O,s.spotShadowMap.length=O,s.directionalShadowMatrix.length=L,s.pointShadowMatrix.length=P,s.spotLightMatrix.length=O+I-F,s.spotLightMap.length=I,s.numSpotLightShadowsWithMaps=F,s.numLightProbes=z,$.directionalLength=M,$.pointLength=b,$.spotLength=C,$.rectAreaLength=y,$.hemiLength=x,$.numDirectionalShadows=L,$.numPointShadows=P,$.numSpotShadows=O,$.numSpotMaps=I,$.numLightProbes=z,s.version=yA++)}function m(p,g){let _=0,S=0,M=0,b=0,C=0;const y=g.matrixWorldInverse;for(let x=0,L=p.length;x<L;x++){const P=p[x];if(P.isDirectionalLight){const O=s.directional[_];O.direction.setFromMatrixPosition(P.matrixWorld),l.setFromMatrixPosition(P.target.matrixWorld),O.direction.sub(l),O.direction.transformDirection(y),_++}else if(P.isSpotLight){const O=s.spot[M];O.position.setFromMatrixPosition(P.matrixWorld),O.position.applyMatrix4(y),O.direction.setFromMatrixPosition(P.matrixWorld),l.setFromMatrixPosition(P.target.matrixWorld),O.direction.sub(l),O.direction.transformDirection(y),M++}else if(P.isRectAreaLight){const O=s.rectArea[b];O.position.setFromMatrixPosition(P.matrixWorld),O.position.applyMatrix4(y),h.identity(),u.copy(P.matrixWorld),u.premultiply(y),h.extractRotation(u),O.halfWidth.set(P.width*.5,0,0),O.halfHeight.set(0,P.height*.5,0),O.halfWidth.applyMatrix4(h),O.halfHeight.applyMatrix4(h),b++}else if(P.isPointLight){const O=s.point[S];O.position.setFromMatrixPosition(P.matrixWorld),O.position.applyMatrix4(y),S++}else if(P.isHemisphereLight){const O=s.hemi[C];O.direction.setFromMatrixPosition(P.matrixWorld),O.direction.transformDirection(y),C++}}}return{setup:d,setupView:m,state:s}}function iv(r){const t=new EA(r),i=[],s=[];function l(g){p.camera=g,i.length=0,s.length=0}function u(g){i.push(g)}function h(g){s.push(g)}function d(){t.setup(i)}function m(g){t.setupView(i,g)}const p={lightsArray:i,shadowsArray:s,camera:null,lights:t,transmissionRenderTarget:{}};return{init:l,state:p,setupLights:d,setupLightsView:m,pushLight:u,pushShadow:h}}function bA(r){let t=new WeakMap;function i(l,u=0){const h=t.get(l);let d;return h===void 0?(d=new iv(r),t.set(l,[d])):u>=h.length?(d=new iv(r),h.push(d)):d=h[u],d}function s(){t=new WeakMap}return{get:i,dispose:s}}const TA=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;class zA{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,i){if(this.texture===null){const s=new Hv(t.texture);(t.depthNear!==i.depthNear||t.depthFar!==i.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=s}}getMesh(t){if(this.texture!==null&&this.mesh===null){const i=t.cameras[0].viewport,s=new qi({vertexShader:OA,fragmentShader:PA,uniforms:{depthColor:{value:this.texture},depthWidth:{value:i.z},depthHeight:{value:i.w}}});this.mesh=new Yi(new hc(20,20),s)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class IA extends Hs{constructor(t,i){super();const s=this;let l=null,u=1,h=null,d="local-floor",m=1,p=null,g=null,_=null,S=null,M=null,b=null;const C=typeof XRWebGLBinding<"u",y=new zA,x={},L=i.getContextAttributes();let P=null,O=null;const I=[],F=[],z=new ne;let $=null;const R=new vi;R.viewport=new on;const w=new vi;w.viewport=new on;const B=[R,w],K=new WM;let Z=null,ct=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(at){let W=I[at];return W===void 0&&(W=new Yh,I[at]=W),W.getTargetRaySpace()},this.getControllerGrip=function(at){let W=I[at];return W===void 0&&(W=new Yh,I[at]=W),W.getGripSpace()},this.getHand=function(at){let W=I[at];return W===void 0&&(W=new Yh,I[at]=W),W.getHandSpace()};function it(at){const W=F.indexOf(at.inputSource);if(W===-1)return;const vt=I[W];vt!==void 0&&(vt.update(at.inputSource,at.frame,p||h),vt.dispatchEvent({type:at.type,data:at.inputSource}))}function N(){l.removeEventListener("select",it),l.removeEventListener("selectstart",it),l.removeEventListener("selectend",it),l.removeEventListener("squeeze",it),l.removeEventListener("squeezestart",it),l.removeEventListener("squeezeend",it),l.removeEventListener("end",N),l.removeEventListener("inputsourceschange",G);for(let at=0;at<I.length;at++){const W=F[at];W!==null&&(F[at]=null,I[at].disconnect(W))}Z=null,ct=null,y.reset();for(const at in x)delete x[at];t.setRenderTarget(P),M=null,S=null,_=null,l=null,O=null,Ht.stop(),s.isPresenting=!1,t.setPixelRatio($),t.setSize(z.width,z.height,!1),s.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(at){u=at,s.isPresenting===!0&&ae("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(at){d=at,s.isPresenting===!0&&ae("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return p||h},this.setReferenceSpace=function(at){p=at},this.getBaseLayer=function(){return S!==null?S:M},this.getBinding=function(){return _===null&&C&&(_=new XRWebGLBinding(l,i)),_},this.getFrame=function(){return b},this.getSession=function(){return l},this.setSession=async function(at){if(l=at,l!==null){if(P=t.getRenderTarget(),l.addEventListener("select",it),l.addEventListener("selectstart",it),l.addEventListener("selectend",it),l.addEventListener("squeeze",it),l.addEventListener("squeezestart",it),l.addEventListener("squeezeend",it),l.addEventListener("end",N),l.addEventListener("inputsourceschange",G),L.xrCompatible!==!0&&await i.makeXRCompatible(),$=t.getPixelRatio(),t.getSize(z),C&&"createProjectionLayer"in XRWebGLBinding.prototype){let vt=null,Ut=null,Ot=null;L.depth&&(Ot=L.stencil?i.DEPTH24_STENCIL8:i.DEPTH_COMPONENT24,vt=L.stencil?Ps:ba,Ut=L.stencil?ll:Wi);const ce={colorFormat:i.RGBA8,depthFormat:Ot,scaleFactor:u};_=this.getBinding(),S=_.createProjectionLayer(ce),l.updateRenderState({layers:[S]}),t.setPixelRatio(1),t.setSize(S.textureWidth,S.textureHeight,!1),O=new Xi(S.textureWidth,S.textureHeight,{format:Li,type:xi,depthTexture:new fl(S.textureWidth,S.textureHeight,Ut,void 0,void 0,void 0,void 0,void 0,void 0,vt),stencilBuffer:L.stencil,colorSpace:t.outputColorSpace,samples:L.antialias?4:0,resolveDepthBuffer:S.ignoreDepthValues===!1,resolveStencilBuffer:S.ignoreDepthValues===!1})}else{const vt={antialias:L.antialias,alpha:!0,depth:L.depth,stencil:L.stencil,framebufferScaleFactor:u};M=new XRWebGLLayer(l,i,vt),l.updateRenderState({baseLayer:M}),t.setPixelRatio(1),t.setSize(M.framebufferWidth,M.framebufferHeight,!1),O=new Xi(M.framebufferWidth,M.framebufferHeight,{format:Li,type:xi,colorSpace:t.outputColorSpace,stencilBuffer:L.stencil,resolveDepthBuffer:M.ignoreDepthValues===!1,resolveStencilBuffer:M.ignoreDepthValues===!1})}O.isXRRenderTarget=!0,this.setFoveation(m),p=null,h=await l.requestReferenceSpace(d),Ht.setContext(l),Ht.start(),s.isPresenting=!0,s.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(l!==null)return l.environmentBlendMode},this.getDepthTexture=function(){return y.getDepthTexture()};function G(at){for(let W=0;W<at.removed.length;W++){const vt=at.removed[W],Ut=F.indexOf(vt);Ut>=0&&(F[Ut]=null,I[Ut].disconnect(vt))}for(let W=0;W<at.added.length;W++){const vt=at.added[W];let Ut=F.indexOf(vt);if(Ut===-1){for(let ce=0;ce<I.length;ce++)if(ce>=F.length){F.push(vt),Ut=ce;break}else if(F[ce]===null){F[ce]=vt,Ut=ce;break}if(Ut===-1)break}const Ot=I[Ut];Ot&&Ot.connect(vt)}}const tt=new J,yt=new J;function xt(at,W,vt){tt.setFromMatrixPosition(W.matrixWorld),yt.setFromMatrixPosition(vt.matrixWorld);const Ut=tt.distanceTo(yt),Ot=W.projectionMatrix.elements,ce=vt.projectionMatrix.elements,tn=Ot[14]/(Ot[10]-1),xe=Ot[14]/(Ot[10]+1),_e=(Ot[9]+1)/Ot[5],we=(Ot[9]-1)/Ot[5],oe=(Ot[8]-1)/Ot[0],en=(ce[8]+1)/ce[0],V=tn*oe,Ke=tn*en,Ee=Ut/(-oe+en),Le=Ee*-oe;if(W.matrixWorld.decompose(at.position,at.quaternion,at.scale),at.translateX(Le),at.translateZ(Ee),at.matrixWorld.compose(at.position,at.quaternion,at.scale),at.matrixWorldInverse.copy(at.matrixWorld).invert(),Ot[10]===-1)at.projectionMatrix.copy(W.projectionMatrix),at.projectionMatrixInverse.copy(W.projectionMatrixInverse);else{const qt=tn+Ee,D=xe+Ee,E=V-Le,Y=Ke+(Ut-Le),dt=_e*xe/D*qt,St=we*xe/D*qt;at.projectionMatrix.makePerspective(E,Y,dt,St,qt,D),at.projectionMatrixInverse.copy(at.projectionMatrix).invert()}}function U(at,W){W===null?at.matrixWorld.copy(at.matrix):at.matrixWorld.multiplyMatrices(W.matrixWorld,at.matrix),at.matrixWorldInverse.copy(at.matrixWorld).invert()}this.updateCamera=function(at){if(l===null)return;let W=at.near,vt=at.far;y.texture!==null&&(y.depthNear>0&&(W=y.depthNear),y.depthFar>0&&(vt=y.depthFar)),K.near=w.near=R.near=W,K.far=w.far=R.far=vt,(Z!==K.near||ct!==K.far)&&(l.updateRenderState({depthNear:K.near,depthFar:K.far}),Z=K.near,ct=K.far),K.layers.mask=at.layers.mask|6,R.layers.mask=K.layers.mask&3,w.layers.mask=K.layers.mask&5;const Ut=at.parent,Ot=K.cameras;U(K,Ut);for(let ce=0;ce<Ot.length;ce++)U(Ot[ce],Ut);Ot.length===2?xt(K,R,w):K.projectionMatrix.copy(R.projectionMatrix),st(at,K,Ut)};function st(at,W,vt){vt===null?at.matrix.copy(W.matrixWorld):(at.matrix.copy(vt.matrixWorld),at.matrix.invert(),at.matrix.multiply(W.matrixWorld)),at.matrix.decompose(at.position,at.quaternion,at.scale),at.updateMatrixWorld(!0),at.projectionMatrix.copy(W.projectionMatrix),at.projectionMatrixInverse.copy(W.projectionMatrixInverse),at.isPerspectiveCamera&&(at.fov=cl*2*Math.atan(1/at.projectionMatrix.elements[5]),at.zoom=1)}this.getCamera=function(){return K},this.getFoveation=function(){if(!(S===null&&M===null))return m},this.setFoveation=function(at){m=at,S!==null&&(S.fixedFoveation=at),M!==null&&M.fixedFoveation!==void 0&&(M.fixedFoveation=at)},this.hasDepthSensing=function(){return y.texture!==null},this.getDepthSensingMesh=function(){return y.getMesh(K)},this.getCameraTexture=function(at){return x[at]};let mt=null;function At(at,W){if(g=W.getViewerPose(p||h),b=W,g!==null){const vt=g.views;M!==null&&(t.setRenderTargetFramebuffer(O,M.framebuffer),t.setRenderTarget(O));let Ut=!1;vt.length!==K.cameras.length&&(K.cameras.length=0,Ut=!0);for(let xe=0;xe<vt.length;xe++){const _e=vt[xe];let we=null;if(M!==null)we=M.getViewport(_e);else{const en=_.getViewSubImage(S,_e);we=en.viewport,xe===0&&(t.setRenderTargetTextures(O,en.colorTexture,en.depthStencilTexture),t.setRenderTarget(O))}let oe=B[xe];oe===void 0&&(oe=new vi,oe.layers.enable(xe),oe.viewport=new on,B[xe]=oe),oe.matrix.fromArray(_e.transform.matrix),oe.matrix.decompose(oe.position,oe.quaternion,oe.scale),oe.projectionMatrix.fromArray(_e.projectionMatrix),oe.projectionMatrixInverse.copy(oe.projectionMatrix).invert(),oe.viewport.set(we.x,we.y,we.width,we.height),xe===0&&(K.matrix.copy(oe.matrix),K.matrix.decompose(K.position,K.quaternion,K.scale)),Ut===!0&&K.cameras.push(oe)}const Ot=l.enabledFeatures;if(Ot&&Ot.includes("depth-sensing")&&l.depthUsage=="gpu-optimized"&&C){_=s.getBinding();const xe=_.getDepthInformation(vt[0]);xe&&xe.isValid&&xe.texture&&y.init(xe,l.renderState)}if(Ot&&Ot.includes("camera-access")&&C){t.state.unbindTexture(),_=s.getBinding();for(let xe=0;xe<vt.length;xe++){const _e=vt[xe].camera;if(_e){let we=x[_e];we||(we=new Hv,x[_e]=we);const oe=_.getCameraImage(_e);we.sourceTexture=oe}}}}for(let vt=0;vt<I.length;vt++){const Ut=F[vt],Ot=I[vt];Ut!==null&&Ot!==void 0&&Ot.update(Ut,W,p||h)}mt&&mt(at,W),W.detectedPlanes&&s.dispatchEvent({type:"planesdetected",data:W}),b=null}const Ht=new Vv;Ht.setAnimationLoop(At),this.setAnimationLoop=function(at){mt=at},this.dispose=function(){}}}const Us=new Ta,FA=new $e;function BA(r,t){function i(y,x){y.matrixAutoUpdate===!0&&y.updateMatrix(),x.value.copy(y.matrix)}function s(y,x){x.color.getRGB(y.fogColor.value,Nv(r)),x.isFog?(y.fogNear.value=x.near,y.fogFar.value=x.far):x.isFogExp2&&(y.fogDensity.value=x.density)}function l(y,x,L,P,O){x.isMeshBasicMaterial||x.isMeshLambertMaterial?u(y,x):x.isMeshToonMaterial?(u(y,x),_(y,x)):x.isMeshPhongMaterial?(u(y,x),g(y,x)):x.isMeshStandardMaterial?(u(y,x),S(y,x),x.isMeshPhysicalMaterial&&M(y,x,O)):x.isMeshMatcapMaterial?(u(y,x),b(y,x)):x.isMeshDepthMaterial?u(y,x):x.isMeshDistanceMaterial?(u(y,x),C(y,x)):x.isMeshNormalMaterial?u(y,x):x.isLineBasicMaterial?(h(y,x),x.isLineDashedMaterial&&d(y,x)):x.isPointsMaterial?m(y,x,L,P):x.isSpriteMaterial?p(y,x):x.isShadowMaterial?(y.color.value.copy(x.color),y.opacity.value=x.opacity):x.isShaderMaterial&&(x.uniformsNeedUpdate=!1)}function u(y,x){y.opacity.value=x.opacity,x.color&&y.diffuse.value.copy(x.color),x.emissive&&y.emissive.value.copy(x.emissive).multiplyScalar(x.emissiveIntensity),x.map&&(y.map.value=x.map,i(x.map,y.mapTransform)),x.alphaMap&&(y.alphaMap.value=x.alphaMap,i(x.alphaMap,y.alphaMapTransform)),x.bumpMap&&(y.bumpMap.value=x.bumpMap,i(x.bumpMap,y.bumpMapTransform),y.bumpScale.value=x.bumpScale,x.side===Zn&&(y.bumpScale.value*=-1)),x.normalMap&&(y.normalMap.value=x.normalMap,i(x.normalMap,y.normalMapTransform),y.normalScale.value.copy(x.normalScale),x.side===Zn&&y.normalScale.value.negate()),x.displacementMap&&(y.displacementMap.value=x.displacementMap,i(x.displacementMap,y.displacementMapTransform),y.displacementScale.value=x.displacementScale,y.displacementBias.value=x.displacementBias),x.emissiveMap&&(y.emissiveMap.value=x.emissiveMap,i(x.emissiveMap,y.emissiveMapTransform)),x.specularMap&&(y.specularMap.value=x.specularMap,i(x.specularMap,y.specularMapTransform)),x.alphaTest>0&&(y.alphaTest.value=x.alphaTest);const L=t.get(x),P=L.envMap,O=L.envMapRotation;P&&(y.envMap.value=P,Us.copy(O),Us.x*=-1,Us.y*=-1,Us.z*=-1,P.isCubeTexture&&P.isRenderTargetTexture===!1&&(Us.y*=-1,Us.z*=-1),y.envMapRotation.value.setFromMatrix4(FA.makeRotationFromEuler(Us)),y.flipEnvMap.value=P.isCubeTexture&&P.isRenderTargetTexture===!1?-1:1,y.reflectivity.value=x.reflectivity,y.ior.value=x.ior,y.refractionRatio.value=x.refractionRatio),x.lightMap&&(y.lightMap.value=x.lightMap,y.lightMapIntensity.value=x.lightMapIntensity,i(x.lightMap,y.lightMapTransform)),x.aoMap&&(y.aoMap.value=x.aoMap,y.aoMapIntensity.value=x.aoMapIntensity,i(x.aoMap,y.aoMapTransform))}function h(y,x){y.diffuse.value.copy(x.color),y.opacity.value=x.opacity,x.map&&(y.map.value=x.map,i(x.map,y.mapTransform))}function d(y,x){y.dashSize.value=x.dashSize,y.totalSize.value=x.dashSize+x.gapSize,y.scale.value=x.scale}function m(y,x,L,P){y.diffuse.value.copy(x.color),y.opacity.value=x.opacity,y.size.value=x.size*L,y.scale.value=P*.5,x.map&&(y.map.value=x.map,i(x.map,y.uvTransform)),x.alphaMap&&(y.alphaMap.value=x.alphaMap,i(x.alphaMap,y.alphaMapTransform)),x.alphaTest>0&&(y.alphaTest.value=x.alphaTest)}function p(y,x){y.diffuse.value.copy(x.color),y.opacity.value=x.opacity,y.rotation.value=x.rotation,x.map&&(y.map.value=x.map,i(x.map,y.mapTransform)),x.alphaMap&&(y.alphaMap.value=x.alphaMap,i(x.alphaMap,y.alphaMapTransform)),x.alphaTest>0&&(y.alphaTest.value=x.alphaTest)}function g(y,x){y.specular.value.copy(x.specular),y.shininess.value=Math.max(x.shininess,1e-4)}function _(y,x){x.gradientMap&&(y.gradientMap.value=x.gradientMap)}function S(y,x){y.metalness.value=x.metalness,x.metalnessMap&&(y.metalnessMap.value=x.metalnessMap,i(x.metalnessMap,y.metalnessMapTransform)),y.roughness.value=x.roughness,x.roughnessMap&&(y.roughnessMap.value=x.roughnessMap,i(x.roughnessMap,y.roughnessMapTransform)),x.envMap&&(y.envMapIntensity.value=x.envMapIntensity)}function M(y,x,L){y.ior.value=x.ior,x.sheen>0&&(y.sheenColor.value.copy(x.sheenColor).multiplyScalar(x.sheen),y.sheenRoughness.value=x.sheenRoughness,x.sheenColorMap&&(y.sheenColorMap.value=x.sheenColorMap,i(x.sheenColorMap,y.sheenColorMapTransform)),x.sheenRoughnessMap&&(y.sheenRoughnessMap.value=x.sheenRoughnessMap,i(x.sheenRoughnessMap,y.sheenRoughnessMapTransform))),x.clearcoat>0&&(y.clearcoat.value=x.clearcoat,y.clearcoatRoughness.value=x.clearcoatRoughness,x.clearcoatMap&&(y.clearcoatMap.value=x.clearcoatMap,i(x.clearcoatMap,y.clearcoatMapTransform)),x.clearcoatRoughnessMap&&(y.clearcoatRoughnessMap.value=x.clearcoatRoughnessMap,i(x.clearcoatRoughnessMap,y.clearcoatRoughnessMapTransform)),x.clearcoatNormalMap&&(y.clearcoatNormalMap.value=x.clearcoatNormalMap,i(x.clearcoatNormalMap,y.clearcoatNormalMapTransform),y.clearcoatNormalScale.value.copy(x.clearcoatNormalScale),x.side===Zn&&y.clearcoatNormalScale.value.negate())),x.dispersion>0&&(y.dispersion.value=x.dispersion),x.iridescence>0&&(y.iridescence.value=x.iridescence,y.iridescenceIOR.value=x.iridescenceIOR,y.iridescenceThicknessMinimum.value=x.iridescenceThicknessRange[0],y.iridescenceThicknessMaximum.value=x.iridescenceThicknessRange[1],x.iridescenceMap&&(y.iridescenceMap.value=x.iridescenceMap,i(x.iridescenceMap,y.iridescenceMapTransform)),x.iridescenceThicknessMap&&(y.iridescenceThicknessMap.value=x.iridescenceThicknessMap,i(x.iridescenceThicknessMap,y.iridescenceThicknessMapTransform))),x.transmission>0&&(y.transmission.value=x.transmission,y.transmissionSamplerMap.value=L.texture,y.transmissionSamplerSize.value.set(L.width,L.height),x.transmissionMap&&(y.transmissionMap.value=x.transmissionMap,i(x.transmissionMap,y.transmissionMapTransform)),y.thickness.value=x.thickness,x.thicknessMap&&(y.thicknessMap.value=x.thicknessMap,i(x.thicknessMap,y.thicknessMapTransform)),y.attenuationDistance.value=x.attenuationDistance,y.attenuationColor.value.copy(x.attenuationColor)),x.anisotropy>0&&(y.anisotropyVector.value.set(x.anisotropy*Math.cos(x.anisotropyRotation),x.anisotropy*Math.sin(x.anisotropyRotation)),x.anisotropyMap&&(y.anisotropyMap.value=x.anisotropyMap,i(x.anisotropyMap,y.anisotropyMapTransform))),y.specularIntensity.value=x.specularIntensity,y.specularColor.value.copy(x.specularColor),x.specularColorMap&&(y.specularColorMap.value=x.specularColorMap,i(x.specularColorMap,y.specularColorMapTransform)),x.specularIntensityMap&&(y.specularIntensityMap.value=x.specularIntensityMap,i(x.specularIntensityMap,y.specularIntensityMapTransform))}function b(y,x){x.matcap&&(y.matcap.value=x.matcap)}function C(y,x){const L=t.get(x).light;y.referencePosition.value.setFromMatrixPosition(L.matrixWorld),y.nearDistance.value=L.shadow.camera.near,y.farDistance.value=L.shadow.camera.far}return{refreshFogUniforms:s,refreshMaterialUniforms:l}}function HA(r,t,i,s){let l={},u={},h=[];const d=r.getParameter(r.MAX_UNIFORM_BUFFER_BINDINGS);function m(L,P){const O=P.program;s.uniformBlockBinding(L,O)}function p(L,P){let O=l[L.id];O===void 0&&(b(L),O=g(L),l[L.id]=O,L.addEventListener("dispose",y));const I=P.program;s.updateUBOMapping(L,I);const F=t.render.frame;u[L.id]!==F&&(S(L),u[L.id]=F)}function g(L){const P=_();L.__bindingPointIndex=P;const O=r.createBuffer(),I=L.__size,F=L.usage;return r.bindBuffer(r.UNIFORM_BUFFER,O),r.bufferData(r.UNIFORM_BUFFER,I,F),r.bindBuffer(r.UNIFORM_BUFFER,null),r.bindBufferBase(r.UNIFORM_BUFFER,P,O),O}function _(){for(let L=0;L<d;L++)if(h.indexOf(L)===-1)return h.push(L),L;return be("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function S(L){const P=l[L.id],O=L.uniforms,I=L.__cache;r.bindBuffer(r.UNIFORM_BUFFER,P);for(let F=0,z=O.length;F<z;F++){const $=Array.isArray(O[F])?O[F]:[O[F]];for(let R=0,w=$.length;R<w;R++){const B=$[R];if(M(B,F,R,I)===!0){const K=B.__offset,Z=Array.isArray(B.value)?B.value:[B.value];let ct=0;for(let it=0;it<Z.length;it++){const N=Z[it],G=C(N);typeof N=="number"||typeof N=="boolean"?(B.__data[0]=N,r.bufferSubData(r.UNIFORM_BUFFER,K+ct,B.__data)):N.isMatrix3?(B.__data[0]=N.elements[0],B.__data[1]=N.elements[1],B.__data[2]=N.elements[2],B.__data[3]=0,B.__data[4]=N.elements[3],B.__data[5]=N.elements[4],B.__data[6]=N.elements[5],B.__data[7]=0,B.__data[8]=N.elements[6],B.__data[9]=N.elements[7],B.__data[10]=N.elements[8],B.__data[11]=0):(N.toArray(B.__data,ct),ct+=G.storage/Float32Array.BYTES_PER_ELEMENT)}r.bufferSubData(r.UNIFORM_BUFFER,K,B.__data)}}}r.bindBuffer(r.UNIFORM_BUFFER,null)}function M(L,P,O,I){const F=L.value,z=P+"_"+O;if(I[z]===void 0)return typeof F=="number"||typeof F=="boolean"?I[z]=F:I[z]=F.clone(),!0;{const $=I[z];if(typeof F=="number"||typeof F=="boolean"){if($!==F)return I[z]=F,!0}else if($.equals(F)===!1)return $.copy(F),!0}return!1}function b(L){const P=L.uniforms;let O=0;const I=16;for(let z=0,$=P.length;z<$;z++){const R=Array.isArray(P[z])?P[z]:[P[z]];for(let w=0,B=R.length;w<B;w++){const K=R[w],Z=Array.isArray(K.value)?K.value:[K.value];for(let ct=0,it=Z.length;ct<it;ct++){const N=Z[ct],G=C(N),tt=O%I,yt=tt%G.boundary,xt=tt+yt;O+=yt,xt!==0&&I-xt<G.storage&&(O+=I-xt),K.__data=new Float32Array(G.storage/Float32Array.BYTES_PER_ELEMENT),K.__offset=O,O+=G.storage}}}const F=O%I;return F>0&&(O+=I-F),L.__size=O,L.__cache={},this}function C(L){const P={boundary:0,storage:0};return typeof L=="number"||typeof L=="boolean"?(P.boundary=4,P.storage=4):L.isVector2?(P.boundary=8,P.storage=8):L.isVector3||L.isColor?(P.boundary=16,P.storage=12):L.isVector4?(P.boundary=16,P.storage=16):L.isMatrix3?(P.boundary=48,P.storage=48):L.isMatrix4?(P.boundary=64,P.storage=64):L.isTexture?ae("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ae("WebGLRenderer: Unsupported uniform value type.",L),P}function y(L){const P=L.target;P.removeEventListener("dispose",y);const O=h.indexOf(P.__bindingPointIndex);h.splice(O,1),r.deleteBuffer(l[P.id]),delete l[P.id],delete u[P.id]}function x(){for(const L in l)r.deleteBuffer(l[L]);h=[],l={},u={}}return{bind:m,update:p,dispose:x}}const GA=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let Bi=null;function VA(){return Bi===null&&(Bi=new PM(GA,16,16,qr,Ea),Bi.name="DFG_LUT",Bi.minFilter=zn,Bi.magFilter=zn,Bi.wrapS=xa,Bi.wrapT=xa,Bi.generateMipmaps=!1,Bi.needsUpdate=!0),Bi}class kA{constructor(t={}){const{canvas:i=Wy(),context:s=null,depth:l=!0,stencil:u=!1,alpha:h=!1,antialias:d=!1,premultipliedAlpha:m=!0,preserveDrawingBuffer:p=!1,powerPreference:g="default",failIfMajorPerformanceCaveat:_=!1,reversedDepthBuffer:S=!1,outputBufferType:M=xi}=t;this.isWebGLRenderer=!0;let b;if(s!==null){if(typeof WebGLRenderingContext<"u"&&s instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");b=s.getContextAttributes().alpha}else b=h;const C=M,y=new Set([lp,op,rp]),x=new Set([xi,Wi,ol,ll,ap,sp]),L=new Uint32Array(4),P=new Int32Array(4);let O=null,I=null;const F=[],z=[];let $=null;this.domElement=i,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=ki,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const R=this;let w=!1;this._outputColorSpace=gi;let B=0,K=0,Z=null,ct=-1,it=null;const N=new on,G=new on;let tt=null;const yt=new Pe(0);let xt=0,U=i.width,st=i.height,mt=1,At=null,Ht=null;const at=new on(0,0,U,st),W=new on(0,0,U,st);let vt=!1;const Ut=new Fv;let Ot=!1,ce=!1;const tn=new $e,xe=new J,_e=new on,we={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let oe=!1;function en(){return Z===null?mt:1}let V=s;function Ke(A,q){return i.getContext(A,q)}try{const A={alpha:!0,depth:l,stencil:u,antialias:d,premultipliedAlpha:m,preserveDrawingBuffer:p,powerPreference:g,failIfMajorPerformanceCaveat:_};if("setAttribute"in i&&i.setAttribute("data-engine",`three.js r${np}`),i.addEventListener("webglcontextlost",ie,!1),i.addEventListener("webglcontextrestored",ze,!1),i.addEventListener("webglcontextcreationerror",Te,!1),V===null){const q="webgl2";if(V=Ke(q,A),V===null)throw Ke(q)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(A){throw be("WebGLRenderer: "+A.message),A}let Ee,Le,qt,D,E,Y,dt,St,ft,Zt,wt,Xt,ee,Et,bt,Bt,It,Dt,fe,X,Lt,Tt,Ft,Mt;function gt(){Ee=new VT(V),Ee.init(),Tt=new LA(V,Ee),Le=new LT(V,Ee,t,Tt),qt=new UA(V,Ee),Le.reversedDepthBuffer&&S&&qt.buffers.depth.setReversed(!0),D=new WT(V),E=new _A,Y=new NA(V,Ee,qt,E,Le,Tt,D),dt=new PT(R),St=new GT(R),ft=new ZM(V),Ft=new UT(V,ft),Zt=new kT(V,ft,D,Ft),wt=new qT(V,Zt,ft,D),fe=new YT(V,Le,Y),Bt=new OT(E),Xt=new mA(R,dt,St,Ee,Le,Ft,Bt),ee=new BA(R,E),Et=new vA,bt=new bA(Ee),Dt=new DT(R,dt,St,qt,wt,b,m),It=new wA(R,wt,Le),Mt=new HA(V,D,Le,qt),X=new NT(V,Ee,D),Lt=new XT(V,Ee,D),D.programs=Xt.programs,R.capabilities=Le,R.extensions=Ee,R.properties=E,R.renderLists=Et,R.shadowMap=It,R.state=qt,R.info=D}gt(),C!==xi&&($=new ZT(C,i.width,i.height,l,u));const Rt=new IA(R,V);this.xr=Rt,this.getContext=function(){return V},this.getContextAttributes=function(){return V.getContextAttributes()},this.forceContextLoss=function(){const A=Ee.get("WEBGL_lose_context");A&&A.loseContext()},this.forceContextRestore=function(){const A=Ee.get("WEBGL_lose_context");A&&A.restoreContext()},this.getPixelRatio=function(){return mt},this.setPixelRatio=function(A){A!==void 0&&(mt=A,this.setSize(U,st,!1))},this.getSize=function(A){return A.set(U,st)},this.setSize=function(A,q,lt=!0){if(Rt.isPresenting){ae("WebGLRenderer: Can't change size while VR device is presenting.");return}U=A,st=q,i.width=Math.floor(A*mt),i.height=Math.floor(q*mt),lt===!0&&(i.style.width=A+"px",i.style.height=q+"px"),$!==null&&$.setSize(i.width,i.height),this.setViewport(0,0,A,q)},this.getDrawingBufferSize=function(A){return A.set(U*mt,st*mt).floor()},this.setDrawingBufferSize=function(A,q,lt){U=A,st=q,mt=lt,i.width=Math.floor(A*lt),i.height=Math.floor(q*lt),this.setViewport(0,0,A,q)},this.setEffects=function(A){if(C===xi){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(A){for(let q=0;q<A.length;q++)if(A[q].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}$.setEffects(A||[])},this.getCurrentViewport=function(A){return A.copy(N)},this.getViewport=function(A){return A.copy(at)},this.setViewport=function(A,q,lt,rt){A.isVector4?at.set(A.x,A.y,A.z,A.w):at.set(A,q,lt,rt),qt.viewport(N.copy(at).multiplyScalar(mt).round())},this.getScissor=function(A){return A.copy(W)},this.setScissor=function(A,q,lt,rt){A.isVector4?W.set(A.x,A.y,A.z,A.w):W.set(A,q,lt,rt),qt.scissor(G.copy(W).multiplyScalar(mt).round())},this.getScissorTest=function(){return vt},this.setScissorTest=function(A){qt.setScissorTest(vt=A)},this.setOpaqueSort=function(A){At=A},this.setTransparentSort=function(A){Ht=A},this.getClearColor=function(A){return A.copy(Dt.getClearColor())},this.setClearColor=function(){Dt.setClearColor(...arguments)},this.getClearAlpha=function(){return Dt.getClearAlpha()},this.setClearAlpha=function(){Dt.setClearAlpha(...arguments)},this.clear=function(A=!0,q=!0,lt=!0){let rt=0;if(A){let Q=!1;if(Z!==null){const Nt=Z.texture.format;Q=y.has(Nt)}if(Q){const Nt=Z.texture.type,Gt=x.has(Nt),Pt=Dt.getClearColor(),Vt=Dt.getClearAlpha(),Wt=Pt.r,Jt=Pt.g,Yt=Pt.b;Gt?(L[0]=Wt,L[1]=Jt,L[2]=Yt,L[3]=Vt,V.clearBufferuiv(V.COLOR,0,L)):(P[0]=Wt,P[1]=Jt,P[2]=Yt,P[3]=Vt,V.clearBufferiv(V.COLOR,0,P))}else rt|=V.COLOR_BUFFER_BIT}q&&(rt|=V.DEPTH_BUFFER_BIT),lt&&(rt|=V.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),V.clear(rt)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){i.removeEventListener("webglcontextlost",ie,!1),i.removeEventListener("webglcontextrestored",ze,!1),i.removeEventListener("webglcontextcreationerror",Te,!1),Dt.dispose(),Et.dispose(),bt.dispose(),E.dispose(),dt.dispose(),St.dispose(),wt.dispose(),Ft.dispose(),Mt.dispose(),Xt.dispose(),Rt.dispose(),Rt.removeEventListener("sessionstart",Vs),Rt.removeEventListener("sessionend",to),Oi.stop()};function ie(A){A.preventDefault(),oc("WebGLRenderer: Context Lost."),w=!0}function ze(){oc("WebGLRenderer: Context Restored."),w=!1;const A=D.autoReset,q=It.enabled,lt=It.autoUpdate,rt=It.needsUpdate,Q=It.type;gt(),D.autoReset=A,It.enabled=q,It.autoUpdate=lt,It.needsUpdate=rt,It.type=Q}function Te(A){be("WebGLRenderer: A WebGL context could not be created. Reason: ",A.statusMessage)}function Nn(A){const q=A.target;q.removeEventListener("dispose",Nn),Ei(q)}function Ei(A){pl(A),E.remove(A)}function pl(A){const q=E.get(A).programs;q!==void 0&&(q.forEach(function(lt){Xt.releaseProgram(lt)}),A.isShaderMaterial&&Xt.releaseShaderCache(A))}this.renderBufferDirect=function(A,q,lt,rt,Q,Nt){q===null&&(q=we);const Gt=Q.isMesh&&Q.matrixWorld.determinant()<0,Pt=ls(A,q,lt,rt,Q);qt.setMaterial(rt,Gt);let Vt=lt.index,Wt=1;if(rt.wireframe===!0){if(Vt=Zt.getWireframeAttribute(lt),Vt===void 0)return;Wt=2}const Jt=lt.drawRange,Yt=lt.attributes.position;let $t=Jt.start*Wt,De=(Jt.start+Jt.count)*Wt;Nt!==null&&($t=Math.max($t,Nt.start*Wt),De=Math.min(De,(Nt.start+Nt.count)*Wt)),Vt!==null?($t=Math.max($t,0),De=Math.min(De,Vt.count)):Yt!=null&&($t=Math.max($t,0),De=Math.min(De,Yt.count));const Qe=De-$t;if(Qe<0||Qe===1/0)return;Ft.setup(Q,rt,Pt,lt,Vt);let qe,Oe=X;if(Vt!==null&&(qe=ft.get(Vt),Oe=Lt,Oe.setIndex(qe)),Q.isMesh)rt.wireframe===!0?(qt.setLineWidth(rt.wireframeLinewidth*en()),Oe.setMode(V.LINES)):Oe.setMode(V.TRIANGLES);else if(Q.isLine){let Kt=rt.linewidth;Kt===void 0&&(Kt=1),qt.setLineWidth(Kt*en()),Q.isLineSegments?Oe.setMode(V.LINES):Q.isLineLoop?Oe.setMode(V.LINE_LOOP):Oe.setMode(V.LINE_STRIP)}else Q.isPoints?Oe.setMode(V.POINTS):Q.isSprite&&Oe.setMode(V.TRIANGLES);if(Q.isBatchedMesh)if(Q._multiDrawInstances!==null)ul("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),Oe.renderMultiDrawInstances(Q._multiDrawStarts,Q._multiDrawCounts,Q._multiDrawCount,Q._multiDrawInstances);else if(Ee.get("WEBGL_multi_draw"))Oe.renderMultiDraw(Q._multiDrawStarts,Q._multiDrawCounts,Q._multiDrawCount);else{const Kt=Q._multiDrawStarts,Ue=Q._multiDrawCounts,se=Q._multiDrawCount,Mn=Vt?ft.get(Vt).bytesPerElement:1,Zi=E.get(rt).currentProgram.getUniforms();for(let En=0;En<se;En++)Zi.setValue(V,"_gl_DrawID",En),Oe.render(Kt[En]/Mn,Ue[En])}else if(Q.isInstancedMesh)Oe.renderInstances($t,Qe,Q.count);else if(lt.isInstancedBufferGeometry){const Kt=lt._maxInstanceCount!==void 0?lt._maxInstanceCount:1/0,Ue=Math.min(lt.instanceCount,Kt);Oe.renderInstances($t,Qe,Ue)}else Oe.render($t,Qe)};function Jr(A,q,lt){A.transparent===!0&&A.side===va&&A.forceSinglePass===!1?(A.side=Zn,A.needsUpdate=!0,Xs(A,q,lt),A.side=os,A.needsUpdate=!0,Xs(A,q,lt),A.side=va):Xs(A,q,lt)}this.compile=function(A,q,lt=null){lt===null&&(lt=A),I=bt.get(lt),I.init(q),z.push(I),lt.traverseVisible(function(Q){Q.isLight&&Q.layers.test(q.layers)&&(I.pushLight(Q),Q.castShadow&&I.pushShadow(Q))}),A!==lt&&A.traverseVisible(function(Q){Q.isLight&&Q.layers.test(q.layers)&&(I.pushLight(Q),Q.castShadow&&I.pushShadow(Q))}),I.setupLights();const rt=new Set;return A.traverse(function(Q){if(!(Q.isMesh||Q.isPoints||Q.isLine||Q.isSprite))return;const Nt=Q.material;if(Nt)if(Array.isArray(Nt))for(let Gt=0;Gt<Nt.length;Gt++){const Pt=Nt[Gt];Jr(Pt,lt,Q),rt.add(Pt)}else Jr(Nt,lt,Q),rt.add(Nt)}),I=z.pop(),rt},this.compileAsync=function(A,q,lt=null){const rt=this.compile(A,q,lt);return new Promise(Q=>{function Nt(){if(rt.forEach(function(Gt){E.get(Gt).currentProgram.isReady()&&rt.delete(Gt)}),rt.size===0){Q(A);return}setTimeout(Nt,10)}Ee.get("KHR_parallel_shader_compile")!==null?Nt():setTimeout(Nt,10)})};let Gs=null;function $r(A){Gs&&Gs(A)}function Vs(){Oi.stop()}function to(){Oi.start()}const Oi=new Vv;Oi.setAnimationLoop($r),typeof self<"u"&&Oi.setContext(self),this.setAnimationLoop=function(A){Gs=A,Rt.setAnimationLoop(A),A===null?Oi.stop():Oi.start()},Rt.addEventListener("sessionstart",Vs),Rt.addEventListener("sessionend",to),this.render=function(A,q){if(q!==void 0&&q.isCamera!==!0){be("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(w===!0)return;const lt=Rt.enabled===!0&&Rt.isPresenting===!0,rt=$!==null&&(Z===null||lt)&&$.begin(R,Z);if(A.matrixWorldAutoUpdate===!0&&A.updateMatrixWorld(),q.parent===null&&q.matrixWorldAutoUpdate===!0&&q.updateMatrixWorld(),Rt.enabled===!0&&Rt.isPresenting===!0&&($===null||$.isCompositing()===!1)&&(Rt.cameraAutoUpdate===!0&&Rt.updateCamera(q),q=Rt.getCamera()),A.isScene===!0&&A.onBeforeRender(R,A,q,Z),I=bt.get(A,z.length),I.init(q),z.push(I),tn.multiplyMatrices(q.projectionMatrix,q.matrixWorldInverse),Ut.setFromProjectionMatrix(tn,Vi,q.reversedDepth),ce=this.localClippingEnabled,Ot=Bt.init(this.clippingPlanes,ce),O=Et.get(A,F.length),O.init(),F.push(O),Rt.enabled===!0&&Rt.isPresenting===!0){const Gt=R.xr.getDepthSensingMesh();Gt!==null&&ri(Gt,q,-1/0,R.sortObjects)}ri(A,q,0,R.sortObjects),O.finish(),R.sortObjects===!0&&O.sort(At,Ht),oe=Rt.enabled===!1||Rt.isPresenting===!1||Rt.hasDepthSensing()===!1,oe&&Dt.addToRenderList(O,A),this.info.render.frame++,Ot===!0&&Bt.beginShadows();const Q=I.state.shadowsArray;if(It.render(Q,A,q),Ot===!0&&Bt.endShadows(),this.info.autoReset===!0&&this.info.reset(),(rt&&$.hasRenderPass())===!1){const Gt=O.opaque,Pt=O.transmissive;if(I.setupLights(),q.isArrayCamera){const Vt=q.cameras;if(Pt.length>0)for(let Wt=0,Jt=Vt.length;Wt<Jt;Wt++){const Yt=Vt[Wt];yn(Gt,Pt,A,Yt)}oe&&Dt.render(A);for(let Wt=0,Jt=Vt.length;Wt<Jt;Wt++){const Yt=Vt[Wt];ln(O,A,Yt,Yt.viewport)}}else Pt.length>0&&yn(Gt,Pt,A,q),oe&&Dt.render(A),ln(O,A,q)}Z!==null&&K===0&&(Y.updateMultisampleRenderTarget(Z),Y.updateRenderTargetMipmap(Z)),rt&&$.end(R),A.isScene===!0&&A.onAfterRender(R,A,q),Ft.resetDefaultState(),ct=-1,it=null,z.pop(),z.length>0?(I=z[z.length-1],Ot===!0&&Bt.setGlobalState(R.clippingPlanes,I.state.camera)):I=null,F.pop(),F.length>0?O=F[F.length-1]:O=null};function ri(A,q,lt,rt){if(A.visible===!1)return;if(A.layers.test(q.layers)){if(A.isGroup)lt=A.renderOrder;else if(A.isLOD)A.autoUpdate===!0&&A.update(q);else if(A.isLight)I.pushLight(A),A.castShadow&&I.pushShadow(A);else if(A.isSprite){if(!A.frustumCulled||Ut.intersectsSprite(A)){rt&&_e.setFromMatrixPosition(A.matrixWorld).applyMatrix4(tn);const Gt=wt.update(A),Pt=A.material;Pt.visible&&O.push(A,Gt,Pt,lt,_e.z,null)}}else if((A.isMesh||A.isLine||A.isPoints)&&(!A.frustumCulled||Ut.intersectsObject(A))){const Gt=wt.update(A),Pt=A.material;if(rt&&(A.boundingSphere!==void 0?(A.boundingSphere===null&&A.computeBoundingSphere(),_e.copy(A.boundingSphere.center)):(Gt.boundingSphere===null&&Gt.computeBoundingSphere(),_e.copy(Gt.boundingSphere.center)),_e.applyMatrix4(A.matrixWorld).applyMatrix4(tn)),Array.isArray(Pt)){const Vt=Gt.groups;for(let Wt=0,Jt=Vt.length;Wt<Jt;Wt++){const Yt=Vt[Wt],$t=Pt[Yt.materialIndex];$t&&$t.visible&&O.push(A,Gt,$t,lt,_e.z,Yt)}}else Pt.visible&&O.push(A,Gt,Pt,lt,_e.z,null)}}const Nt=A.children;for(let Gt=0,Pt=Nt.length;Gt<Pt;Gt++)ri(Nt[Gt],q,lt,rt)}function ln(A,q,lt,rt){const{opaque:Q,transmissive:Nt,transparent:Gt}=A;I.setupLightsView(lt),Ot===!0&&Bt.setGlobalState(R.clippingPlanes,lt),rt&&qt.viewport(N.copy(rt)),Q.length>0&&bi(Q,q,lt),Nt.length>0&&bi(Nt,q,lt),Gt.length>0&&bi(Gt,q,lt),qt.buffers.depth.setTest(!0),qt.buffers.depth.setMask(!0),qt.buffers.color.setMask(!0),qt.setPolygonOffset(!1)}function yn(A,q,lt,rt){if((lt.isScene===!0?lt.overrideMaterial:null)!==null)return;if(I.state.transmissionRenderTarget[rt.id]===void 0){const $t=Ee.has("EXT_color_buffer_half_float")||Ee.has("EXT_color_buffer_float");I.state.transmissionRenderTarget[rt.id]=new Xi(1,1,{generateMipmaps:!0,type:$t?Ea:xi,minFilter:Os,samples:Le.samples,stencilBuffer:u,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ae.workingColorSpace})}const Nt=I.state.transmissionRenderTarget[rt.id],Gt=rt.viewport||N;Nt.setSize(Gt.z*R.transmissionResolutionScale,Gt.w*R.transmissionResolutionScale);const Pt=R.getRenderTarget(),Vt=R.getActiveCubeFace(),Wt=R.getActiveMipmapLevel();R.setRenderTarget(Nt),R.getClearColor(yt),xt=R.getClearAlpha(),xt<1&&R.setClearColor(16777215,.5),R.clear(),oe&&Dt.render(lt);const Jt=R.toneMapping;R.toneMapping=ki;const Yt=rt.viewport;if(rt.viewport!==void 0&&(rt.viewport=void 0),I.setupLightsView(rt),Ot===!0&&Bt.setGlobalState(R.clippingPlanes,rt),bi(A,lt,rt),Y.updateMultisampleRenderTarget(Nt),Y.updateRenderTargetMipmap(Nt),Ee.has("WEBGL_multisampled_render_to_texture")===!1){let $t=!1;for(let De=0,Qe=q.length;De<Qe;De++){const qe=q[De],{object:Oe,geometry:Kt,material:Ue,group:se}=qe;if(Ue.side===va&&Oe.layers.test(rt.layers)){const Mn=Ue.side;Ue.side=Zn,Ue.needsUpdate=!0,ks(Oe,lt,rt,Kt,Ue,se),Ue.side=Mn,Ue.needsUpdate=!0,$t=!0}}$t===!0&&(Y.updateMultisampleRenderTarget(Nt),Y.updateRenderTargetMipmap(Nt))}R.setRenderTarget(Pt,Vt,Wt),R.setClearColor(yt,xt),Yt!==void 0&&(rt.viewport=Yt),R.toneMapping=Jt}function bi(A,q,lt){const rt=q.isScene===!0?q.overrideMaterial:null;for(let Q=0,Nt=A.length;Q<Nt;Q++){const Gt=A[Q],{object:Pt,geometry:Vt,group:Wt}=Gt;let Jt=Gt.material;Jt.allowOverride===!0&&rt!==null&&(Jt=rt),Pt.layers.test(lt.layers)&&ks(Pt,q,lt,Vt,Jt,Wt)}}function ks(A,q,lt,rt,Q,Nt){A.onBeforeRender(R,q,lt,rt,Q,Nt),A.modelViewMatrix.multiplyMatrices(lt.matrixWorldInverse,A.matrixWorld),A.normalMatrix.getNormalMatrix(A.modelViewMatrix),Q.onBeforeRender(R,q,lt,rt,A,Nt),Q.transparent===!0&&Q.side===va&&Q.forceSinglePass===!1?(Q.side=Zn,Q.needsUpdate=!0,R.renderBufferDirect(lt,q,rt,Q,A,Nt),Q.side=os,Q.needsUpdate=!0,R.renderBufferDirect(lt,q,rt,Q,A,Nt),Q.side=va):R.renderBufferDirect(lt,q,rt,Q,A,Nt),A.onAfterRender(R,q,lt,rt,Q,Nt)}function Xs(A,q,lt){q.isScene!==!0&&(q=we);const rt=E.get(A),Q=I.state.lights,Nt=I.state.shadowsArray,Gt=Q.state.version,Pt=Xt.getParameters(A,Q.state,Nt,q,lt),Vt=Xt.getProgramCacheKey(Pt);let Wt=rt.programs;rt.environment=A.isMeshStandardMaterial?q.environment:null,rt.fog=q.fog,rt.envMap=(A.isMeshStandardMaterial?St:dt).get(A.envMap||rt.environment),rt.envMapRotation=rt.environment!==null&&A.envMap===null?q.environmentRotation:A.envMapRotation,Wt===void 0&&(A.addEventListener("dispose",Nn),Wt=new Map,rt.programs=Wt);let Jt=Wt.get(Vt);if(Jt!==void 0){if(rt.currentProgram===Jt&&rt.lightsStateVersion===Gt)return eo(A,Pt),Jt}else Pt.uniforms=Xt.getUniforms(A),A.onBeforeCompile(Pt,R),Jt=Xt.acquireProgram(Pt,Vt),Wt.set(Vt,Jt),rt.uniforms=Pt.uniforms;const Yt=rt.uniforms;return(!A.isShaderMaterial&&!A.isRawShaderMaterial||A.clipping===!0)&&(Yt.clippingPlanes=Bt.uniform),eo(A,Pt),rt.needsLights=Aa(A),rt.lightsStateVersion=Gt,rt.needsLights&&(Yt.ambientLightColor.value=Q.state.ambient,Yt.lightProbe.value=Q.state.probe,Yt.directionalLights.value=Q.state.directional,Yt.directionalLightShadows.value=Q.state.directionalShadow,Yt.spotLights.value=Q.state.spot,Yt.spotLightShadows.value=Q.state.spotShadow,Yt.rectAreaLights.value=Q.state.rectArea,Yt.ltc_1.value=Q.state.rectAreaLTC1,Yt.ltc_2.value=Q.state.rectAreaLTC2,Yt.pointLights.value=Q.state.point,Yt.pointLightShadows.value=Q.state.pointShadow,Yt.hemisphereLights.value=Q.state.hemi,Yt.directionalShadowMap.value=Q.state.directionalShadowMap,Yt.directionalShadowMatrix.value=Q.state.directionalShadowMatrix,Yt.spotShadowMap.value=Q.state.spotShadowMap,Yt.spotLightMatrix.value=Q.state.spotLightMatrix,Yt.spotLightMap.value=Q.state.spotLightMap,Yt.pointShadowMap.value=Q.state.pointShadowMap,Yt.pointShadowMatrix.value=Q.state.pointShadowMatrix),rt.currentProgram=Jt,rt.uniformsList=null,Jt}function ml(A){if(A.uniformsList===null){const q=A.currentProgram.getUniforms();A.uniformsList=nc.seqWithValue(q.seq,A.uniforms)}return A.uniformsList}function eo(A,q){const lt=E.get(A);lt.outputColorSpace=q.outputColorSpace,lt.batching=q.batching,lt.batchingColor=q.batchingColor,lt.instancing=q.instancing,lt.instancingColor=q.instancingColor,lt.instancingMorph=q.instancingMorph,lt.skinning=q.skinning,lt.morphTargets=q.morphTargets,lt.morphNormals=q.morphNormals,lt.morphColors=q.morphColors,lt.morphTargetsCount=q.morphTargetsCount,lt.numClippingPlanes=q.numClippingPlanes,lt.numIntersection=q.numClipIntersection,lt.vertexAlphas=q.vertexAlphas,lt.vertexTangents=q.vertexTangents,lt.toneMapping=q.toneMapping}function ls(A,q,lt,rt,Q){q.isScene!==!0&&(q=we),Y.resetTextureUnits();const Nt=q.fog,Gt=rt.isMeshStandardMaterial?q.environment:null,Pt=Z===null?R.outputColorSpace:Z.isXRRenderTarget===!0?Z.texture.colorSpace:jr,Vt=(rt.isMeshStandardMaterial?St:dt).get(rt.envMap||Gt),Wt=rt.vertexColors===!0&&!!lt.attributes.color&&lt.attributes.color.itemSize===4,Jt=!!lt.attributes.tangent&&(!!rt.normalMap||rt.anisotropy>0),Yt=!!lt.morphAttributes.position,$t=!!lt.morphAttributes.normal,De=!!lt.morphAttributes.color;let Qe=ki;rt.toneMapped&&(Z===null||Z.isXRRenderTarget===!0)&&(Qe=R.toneMapping);const qe=lt.morphAttributes.position||lt.morphAttributes.normal||lt.morphAttributes.color,Oe=qe!==void 0?qe.length:0,Kt=E.get(rt),Ue=I.state.lights;if(Ot===!0&&(ce===!0||A!==it)){const Tn=A===it&&rt.id===ct;Bt.setState(rt,A,Tn)}let se=!1;rt.version===Kt.__version?(Kt.needsLights&&Kt.lightsStateVersion!==Ue.state.version||Kt.outputColorSpace!==Pt||Q.isBatchedMesh&&Kt.batching===!1||!Q.isBatchedMesh&&Kt.batching===!0||Q.isBatchedMesh&&Kt.batchingColor===!0&&Q.colorTexture===null||Q.isBatchedMesh&&Kt.batchingColor===!1&&Q.colorTexture!==null||Q.isInstancedMesh&&Kt.instancing===!1||!Q.isInstancedMesh&&Kt.instancing===!0||Q.isSkinnedMesh&&Kt.skinning===!1||!Q.isSkinnedMesh&&Kt.skinning===!0||Q.isInstancedMesh&&Kt.instancingColor===!0&&Q.instanceColor===null||Q.isInstancedMesh&&Kt.instancingColor===!1&&Q.instanceColor!==null||Q.isInstancedMesh&&Kt.instancingMorph===!0&&Q.morphTexture===null||Q.isInstancedMesh&&Kt.instancingMorph===!1&&Q.morphTexture!==null||Kt.envMap!==Vt||rt.fog===!0&&Kt.fog!==Nt||Kt.numClippingPlanes!==void 0&&(Kt.numClippingPlanes!==Bt.numPlanes||Kt.numIntersection!==Bt.numIntersection)||Kt.vertexAlphas!==Wt||Kt.vertexTangents!==Jt||Kt.morphTargets!==Yt||Kt.morphNormals!==$t||Kt.morphColors!==De||Kt.toneMapping!==Qe||Kt.morphTargetsCount!==Oe)&&(se=!0):(se=!0,Kt.__version=rt.version);let Mn=Kt.currentProgram;se===!0&&(Mn=Xs(rt,q,Q));let Zi=!1,En=!1,oi=!1;const Ie=Mn.getUniforms(),bn=Kt.uniforms;if(qt.useProgram(Mn.program)&&(Zi=!0,En=!0,oi=!0),rt.id!==ct&&(ct=rt.id,En=!0),Zi||it!==A){qt.buffers.depth.getReversed()&&A.reversedDepth!==!0&&(A._reversedDepth=!0,A.updateProjectionMatrix()),Ie.setValue(V,"projectionMatrix",A.projectionMatrix),Ie.setValue(V,"viewMatrix",A.matrixWorldInverse);const An=Ie.map.cameraPosition;An!==void 0&&An.setValue(V,xe.setFromMatrixPosition(A.matrixWorld)),Le.logarithmicDepthBuffer&&Ie.setValue(V,"logDepthBufFC",2/(Math.log(A.far+1)/Math.LN2)),(rt.isMeshPhongMaterial||rt.isMeshToonMaterial||rt.isMeshLambertMaterial||rt.isMeshBasicMaterial||rt.isMeshStandardMaterial||rt.isShaderMaterial)&&Ie.setValue(V,"isOrthographic",A.isOrthographicCamera===!0),it!==A&&(it=A,En=!0,oi=!0)}if(Kt.needsLights&&(Ue.state.directionalShadowMap.length>0&&Ie.setValue(V,"directionalShadowMap",Ue.state.directionalShadowMap,Y),Ue.state.spotShadowMap.length>0&&Ie.setValue(V,"spotShadowMap",Ue.state.spotShadowMap,Y),Ue.state.pointShadowMap.length>0&&Ie.setValue(V,"pointShadowMap",Ue.state.pointShadowMap,Y)),Q.isSkinnedMesh){Ie.setOptional(V,Q,"bindMatrix"),Ie.setOptional(V,Q,"bindMatrixInverse");const Tn=Q.skeleton;Tn&&(Tn.boneTexture===null&&Tn.computeBoneTexture(),Ie.setValue(V,"boneTexture",Tn.boneTexture,Y))}Q.isBatchedMesh&&(Ie.setOptional(V,Q,"batchingTexture"),Ie.setValue(V,"batchingTexture",Q._matricesTexture,Y),Ie.setOptional(V,Q,"batchingIdTexture"),Ie.setValue(V,"batchingIdTexture",Q._indirectTexture,Y),Ie.setOptional(V,Q,"batchingColorTexture"),Q._colorsTexture!==null&&Ie.setValue(V,"batchingColorTexture",Q._colorsTexture,Y));const pn=lt.morphAttributes;if((pn.position!==void 0||pn.normal!==void 0||pn.color!==void 0)&&fe.update(Q,lt,Mn),(En||Kt.receiveShadow!==Q.receiveShadow)&&(Kt.receiveShadow=Q.receiveShadow,Ie.setValue(V,"receiveShadow",Q.receiveShadow)),rt.isMeshGouraudMaterial&&rt.envMap!==null&&(bn.envMap.value=Vt,bn.flipEnvMap.value=Vt.isCubeTexture&&Vt.isRenderTargetTexture===!1?-1:1),rt.isMeshStandardMaterial&&rt.envMap===null&&q.environment!==null&&(bn.envMapIntensity.value=q.environmentIntensity),bn.dfgLUT!==void 0&&(bn.dfgLUT.value=VA()),En&&(Ie.setValue(V,"toneMappingExposure",R.toneMappingExposure),Kt.needsLights&&no(bn,oi),Nt&&rt.fog===!0&&ee.refreshFogUniforms(bn,Nt),ee.refreshMaterialUniforms(bn,rt,mt,st,I.state.transmissionRenderTarget[A.id]),nc.upload(V,ml(Kt),bn,Y)),rt.isShaderMaterial&&rt.uniformsNeedUpdate===!0&&(nc.upload(V,ml(Kt),bn,Y),rt.uniformsNeedUpdate=!1),rt.isSpriteMaterial&&Ie.setValue(V,"center",Q.center),Ie.setValue(V,"modelViewMatrix",Q.modelViewMatrix),Ie.setValue(V,"normalMatrix",Q.normalMatrix),Ie.setValue(V,"modelMatrix",Q.matrixWorld),rt.isShaderMaterial||rt.isRawShaderMaterial){const Tn=rt.uniformsGroups;for(let An=0,Ws=Tn.length;An<Ws;An++){const Ti=Tn[An];Mt.update(Ti,Mn),Mt.bind(Ti,Mn)}}return Mn}function no(A,q){A.ambientLightColor.needsUpdate=q,A.lightProbe.needsUpdate=q,A.directionalLights.needsUpdate=q,A.directionalLightShadows.needsUpdate=q,A.pointLights.needsUpdate=q,A.pointLightShadows.needsUpdate=q,A.spotLights.needsUpdate=q,A.spotLightShadows.needsUpdate=q,A.rectAreaLights.needsUpdate=q,A.hemisphereLights.needsUpdate=q}function Aa(A){return A.isMeshLambertMaterial||A.isMeshToonMaterial||A.isMeshPhongMaterial||A.isMeshStandardMaterial||A.isShadowMaterial||A.isShaderMaterial&&A.lights===!0}this.getActiveCubeFace=function(){return B},this.getActiveMipmapLevel=function(){return K},this.getRenderTarget=function(){return Z},this.setRenderTargetTextures=function(A,q,lt){const rt=E.get(A);rt.__autoAllocateDepthBuffer=A.resolveDepthBuffer===!1,rt.__autoAllocateDepthBuffer===!1&&(rt.__useRenderToTexture=!1),E.get(A.texture).__webglTexture=q,E.get(A.depthTexture).__webglTexture=rt.__autoAllocateDepthBuffer?void 0:lt,rt.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(A,q){const lt=E.get(A);lt.__webglFramebuffer=q,lt.__useDefaultFramebuffer=q===void 0};const Ra=V.createFramebuffer();this.setRenderTarget=function(A,q=0,lt=0){Z=A,B=q,K=lt;let rt=null,Q=!1,Nt=!1;if(A){const Pt=E.get(A);if(Pt.__useDefaultFramebuffer!==void 0){qt.bindFramebuffer(V.FRAMEBUFFER,Pt.__webglFramebuffer),N.copy(A.viewport),G.copy(A.scissor),tt=A.scissorTest,qt.viewport(N),qt.scissor(G),qt.setScissorTest(tt),ct=-1;return}else if(Pt.__webglFramebuffer===void 0)Y.setupRenderTarget(A);else if(Pt.__hasExternalTextures)Y.rebindTextures(A,E.get(A.texture).__webglTexture,E.get(A.depthTexture).__webglTexture);else if(A.depthBuffer){const Jt=A.depthTexture;if(Pt.__boundDepthTexture!==Jt){if(Jt!==null&&E.has(Jt)&&(A.width!==Jt.image.width||A.height!==Jt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");Y.setupDepthRenderbuffer(A)}}const Vt=A.texture;(Vt.isData3DTexture||Vt.isDataArrayTexture||Vt.isCompressedArrayTexture)&&(Nt=!0);const Wt=E.get(A).__webglFramebuffer;A.isWebGLCubeRenderTarget?(Array.isArray(Wt[q])?rt=Wt[q][lt]:rt=Wt[q],Q=!0):A.samples>0&&Y.useMultisampledRTT(A)===!1?rt=E.get(A).__webglMultisampledFramebuffer:Array.isArray(Wt)?rt=Wt[lt]:rt=Wt,N.copy(A.viewport),G.copy(A.scissor),tt=A.scissorTest}else N.copy(at).multiplyScalar(mt).floor(),G.copy(W).multiplyScalar(mt).floor(),tt=vt;if(lt!==0&&(rt=Ra),qt.bindFramebuffer(V.FRAMEBUFFER,rt)&&qt.drawBuffers(A,rt),qt.viewport(N),qt.scissor(G),qt.setScissorTest(tt),Q){const Pt=E.get(A.texture);V.framebufferTexture2D(V.FRAMEBUFFER,V.COLOR_ATTACHMENT0,V.TEXTURE_CUBE_MAP_POSITIVE_X+q,Pt.__webglTexture,lt)}else if(Nt){const Pt=q;for(let Vt=0;Vt<A.textures.length;Vt++){const Wt=E.get(A.textures[Vt]);V.framebufferTextureLayer(V.FRAMEBUFFER,V.COLOR_ATTACHMENT0+Vt,Wt.__webglTexture,lt,Pt)}}else if(A!==null&&lt!==0){const Pt=E.get(A.texture);V.framebufferTexture2D(V.FRAMEBUFFER,V.COLOR_ATTACHMENT0,V.TEXTURE_2D,Pt.__webglTexture,lt)}ct=-1},this.readRenderTargetPixels=function(A,q,lt,rt,Q,Nt,Gt,Pt=0){if(!(A&&A.isWebGLRenderTarget)){be("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Vt=E.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Gt!==void 0&&(Vt=Vt[Gt]),Vt){qt.bindFramebuffer(V.FRAMEBUFFER,Vt);try{const Wt=A.textures[Pt],Jt=Wt.format,Yt=Wt.type;if(!Le.textureFormatReadable(Jt)){be("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Le.textureTypeReadable(Yt)){be("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}q>=0&&q<=A.width-rt&&lt>=0&&lt<=A.height-Q&&(A.textures.length>1&&V.readBuffer(V.COLOR_ATTACHMENT0+Pt),V.readPixels(q,lt,rt,Q,Tt.convert(Jt),Tt.convert(Yt),Nt))}finally{const Wt=Z!==null?E.get(Z).__webglFramebuffer:null;qt.bindFramebuffer(V.FRAMEBUFFER,Wt)}}},this.readRenderTargetPixelsAsync=async function(A,q,lt,rt,Q,Nt,Gt,Pt=0){if(!(A&&A.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Vt=E.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Gt!==void 0&&(Vt=Vt[Gt]),Vt)if(q>=0&&q<=A.width-rt&&lt>=0&&lt<=A.height-Q){qt.bindFramebuffer(V.FRAMEBUFFER,Vt);const Wt=A.textures[Pt],Jt=Wt.format,Yt=Wt.type;if(!Le.textureFormatReadable(Jt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Le.textureTypeReadable(Yt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const $t=V.createBuffer();V.bindBuffer(V.PIXEL_PACK_BUFFER,$t),V.bufferData(V.PIXEL_PACK_BUFFER,Nt.byteLength,V.STREAM_READ),A.textures.length>1&&V.readBuffer(V.COLOR_ATTACHMENT0+Pt),V.readPixels(q,lt,rt,Q,Tt.convert(Jt),Tt.convert(Yt),0);const De=Z!==null?E.get(Z).__webglFramebuffer:null;qt.bindFramebuffer(V.FRAMEBUFFER,De);const Qe=V.fenceSync(V.SYNC_GPU_COMMANDS_COMPLETE,0);return V.flush(),await Yy(V,Qe,4),V.bindBuffer(V.PIXEL_PACK_BUFFER,$t),V.getBufferSubData(V.PIXEL_PACK_BUFFER,0,Nt),V.deleteBuffer($t),V.deleteSync(Qe),Nt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(A,q=null,lt=0){const rt=Math.pow(2,-lt),Q=Math.floor(A.image.width*rt),Nt=Math.floor(A.image.height*rt),Gt=q!==null?q.x:0,Pt=q!==null?q.y:0;Y.setTexture2D(A,0),V.copyTexSubImage2D(V.TEXTURE_2D,lt,0,0,Gt,Pt,Q,Nt),qt.unbindTexture()};const us=V.createFramebuffer(),Ca=V.createFramebuffer();this.copyTextureToTexture=function(A,q,lt=null,rt=null,Q=0,Nt=null){Nt===null&&(Q!==0?(ul("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Nt=Q,Q=0):Nt=0);let Gt,Pt,Vt,Wt,Jt,Yt,$t,De,Qe;const qe=A.isCompressedTexture?A.mipmaps[Nt]:A.image;if(lt!==null)Gt=lt.max.x-lt.min.x,Pt=lt.max.y-lt.min.y,Vt=lt.isBox3?lt.max.z-lt.min.z:1,Wt=lt.min.x,Jt=lt.min.y,Yt=lt.isBox3?lt.min.z:0;else{const pn=Math.pow(2,-Q);Gt=Math.floor(qe.width*pn),Pt=Math.floor(qe.height*pn),A.isDataArrayTexture?Vt=qe.depth:A.isData3DTexture?Vt=Math.floor(qe.depth*pn):Vt=1,Wt=0,Jt=0,Yt=0}rt!==null?($t=rt.x,De=rt.y,Qe=rt.z):($t=0,De=0,Qe=0);const Oe=Tt.convert(q.format),Kt=Tt.convert(q.type);let Ue;q.isData3DTexture?(Y.setTexture3D(q,0),Ue=V.TEXTURE_3D):q.isDataArrayTexture||q.isCompressedArrayTexture?(Y.setTexture2DArray(q,0),Ue=V.TEXTURE_2D_ARRAY):(Y.setTexture2D(q,0),Ue=V.TEXTURE_2D),V.pixelStorei(V.UNPACK_FLIP_Y_WEBGL,q.flipY),V.pixelStorei(V.UNPACK_PREMULTIPLY_ALPHA_WEBGL,q.premultiplyAlpha),V.pixelStorei(V.UNPACK_ALIGNMENT,q.unpackAlignment);const se=V.getParameter(V.UNPACK_ROW_LENGTH),Mn=V.getParameter(V.UNPACK_IMAGE_HEIGHT),Zi=V.getParameter(V.UNPACK_SKIP_PIXELS),En=V.getParameter(V.UNPACK_SKIP_ROWS),oi=V.getParameter(V.UNPACK_SKIP_IMAGES);V.pixelStorei(V.UNPACK_ROW_LENGTH,qe.width),V.pixelStorei(V.UNPACK_IMAGE_HEIGHT,qe.height),V.pixelStorei(V.UNPACK_SKIP_PIXELS,Wt),V.pixelStorei(V.UNPACK_SKIP_ROWS,Jt),V.pixelStorei(V.UNPACK_SKIP_IMAGES,Yt);const Ie=A.isDataArrayTexture||A.isData3DTexture,bn=q.isDataArrayTexture||q.isData3DTexture;if(A.isDepthTexture){const pn=E.get(A),Tn=E.get(q),An=E.get(pn.__renderTarget),Ws=E.get(Tn.__renderTarget);qt.bindFramebuffer(V.READ_FRAMEBUFFER,An.__webglFramebuffer),qt.bindFramebuffer(V.DRAW_FRAMEBUFFER,Ws.__webglFramebuffer);for(let Ti=0;Ti<Vt;Ti++)Ie&&(V.framebufferTextureLayer(V.READ_FRAMEBUFFER,V.COLOR_ATTACHMENT0,E.get(A).__webglTexture,Q,Yt+Ti),V.framebufferTextureLayer(V.DRAW_FRAMEBUFFER,V.COLOR_ATTACHMENT0,E.get(q).__webglTexture,Nt,Qe+Ti)),V.blitFramebuffer(Wt,Jt,Gt,Pt,$t,De,Gt,Pt,V.DEPTH_BUFFER_BIT,V.NEAREST);qt.bindFramebuffer(V.READ_FRAMEBUFFER,null),qt.bindFramebuffer(V.DRAW_FRAMEBUFFER,null)}else if(Q!==0||A.isRenderTargetTexture||E.has(A)){const pn=E.get(A),Tn=E.get(q);qt.bindFramebuffer(V.READ_FRAMEBUFFER,us),qt.bindFramebuffer(V.DRAW_FRAMEBUFFER,Ca);for(let An=0;An<Vt;An++)Ie?V.framebufferTextureLayer(V.READ_FRAMEBUFFER,V.COLOR_ATTACHMENT0,pn.__webglTexture,Q,Yt+An):V.framebufferTexture2D(V.READ_FRAMEBUFFER,V.COLOR_ATTACHMENT0,V.TEXTURE_2D,pn.__webglTexture,Q),bn?V.framebufferTextureLayer(V.DRAW_FRAMEBUFFER,V.COLOR_ATTACHMENT0,Tn.__webglTexture,Nt,Qe+An):V.framebufferTexture2D(V.DRAW_FRAMEBUFFER,V.COLOR_ATTACHMENT0,V.TEXTURE_2D,Tn.__webglTexture,Nt),Q!==0?V.blitFramebuffer(Wt,Jt,Gt,Pt,$t,De,Gt,Pt,V.COLOR_BUFFER_BIT,V.NEAREST):bn?V.copyTexSubImage3D(Ue,Nt,$t,De,Qe+An,Wt,Jt,Gt,Pt):V.copyTexSubImage2D(Ue,Nt,$t,De,Wt,Jt,Gt,Pt);qt.bindFramebuffer(V.READ_FRAMEBUFFER,null),qt.bindFramebuffer(V.DRAW_FRAMEBUFFER,null)}else bn?A.isDataTexture||A.isData3DTexture?V.texSubImage3D(Ue,Nt,$t,De,Qe,Gt,Pt,Vt,Oe,Kt,qe.data):q.isCompressedArrayTexture?V.compressedTexSubImage3D(Ue,Nt,$t,De,Qe,Gt,Pt,Vt,Oe,qe.data):V.texSubImage3D(Ue,Nt,$t,De,Qe,Gt,Pt,Vt,Oe,Kt,qe):A.isDataTexture?V.texSubImage2D(V.TEXTURE_2D,Nt,$t,De,Gt,Pt,Oe,Kt,qe.data):A.isCompressedTexture?V.compressedTexSubImage2D(V.TEXTURE_2D,Nt,$t,De,qe.width,qe.height,Oe,qe.data):V.texSubImage2D(V.TEXTURE_2D,Nt,$t,De,Gt,Pt,Oe,Kt,qe);V.pixelStorei(V.UNPACK_ROW_LENGTH,se),V.pixelStorei(V.UNPACK_IMAGE_HEIGHT,Mn),V.pixelStorei(V.UNPACK_SKIP_PIXELS,Zi),V.pixelStorei(V.UNPACK_SKIP_ROWS,En),V.pixelStorei(V.UNPACK_SKIP_IMAGES,oi),Nt===0&&q.generateMipmaps&&V.generateMipmap(Ue),qt.unbindTexture()},this.initRenderTarget=function(A){E.get(A).__webglFramebuffer===void 0&&Y.setupRenderTarget(A)},this.initTexture=function(A){A.isCubeTexture?Y.setTextureCube(A,0):A.isData3DTexture?Y.setTexture3D(A,0):A.isDataArrayTexture||A.isCompressedArrayTexture?Y.setTexture2DArray(A,0):Y.setTexture2D(A,0),qt.unbindTexture()},this.resetState=function(){B=0,K=0,Z=null,qt.reset(),Ft.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Vi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const i=this.getContext();i.drawingBufferColorSpace=Ae._getDrawingBufferColorSpace(t),i.unpackColorSpace=Ae._getUnpackColorSpace()}}const sv={type:"change"},_p={type:"start"},qv={type:"end"},Ku=new fc,rv=new as,XA=Math.cos(70*Rv.DEG2RAD),_n=new J,jn=2*Math.PI,We={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},ed=1e-6;class WA extends qM{constructor(t,i=null){super(t,i),this.state=We.NONE,this.target=new J,this.cursor=new J,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:Vr.ROTATE,MIDDLE:Vr.DOLLY,RIGHT:Vr.PAN},this.touches={ONE:Gr.ROTATE,TWO:Gr.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this._lastPosition=new J,this._lastQuaternion=new Bs,this._lastTargetPosition=new J,this._quat=new Bs().setFromUnitVectors(t.up,new J(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new Og,this._sphericalDelta=new Og,this._scale=1,this._panOffset=new J,this._rotateStart=new ne,this._rotateEnd=new ne,this._rotateDelta=new ne,this._panStart=new ne,this._panEnd=new ne,this._panDelta=new ne,this._dollyStart=new ne,this._dollyEnd=new ne,this._dollyDelta=new ne,this._dollyDirection=new J,this._mouse=new ne,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=qA.bind(this),this._onPointerDown=YA.bind(this),this._onPointerUp=jA.bind(this),this._onContextMenu=eR.bind(this),this._onMouseWheel=QA.bind(this),this._onKeyDown=JA.bind(this),this._onTouchStart=$A.bind(this),this._onTouchMove=tR.bind(this),this._onMouseDown=ZA.bind(this),this._onMouseMove=KA.bind(this),this._interceptControlDown=nR.bind(this),this._interceptControlUp=iR.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}connect(t){super.connect(t),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(t){t.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=t}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(sv),this.update(),this.state=We.NONE}update(t=null){const i=this.object.position;_n.copy(i).sub(this.target),_n.applyQuaternion(this._quat),this._spherical.setFromVector3(_n),this.autoRotate&&this.state===We.NONE&&this._rotateLeft(this._getAutoRotationAngle(t)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let s=this.minAzimuthAngle,l=this.maxAzimuthAngle;isFinite(s)&&isFinite(l)&&(s<-Math.PI?s+=jn:s>Math.PI&&(s-=jn),l<-Math.PI?l+=jn:l>Math.PI&&(l-=jn),s<=l?this._spherical.theta=Math.max(s,Math.min(l,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(s+l)/2?Math.max(s,this._spherical.theta):Math.min(l,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let u=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const h=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),u=h!=this._spherical.radius}if(_n.setFromSpherical(this._spherical),_n.applyQuaternion(this._quatInverse),i.copy(this.target).add(_n),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let h=null;if(this.object.isPerspectiveCamera){const d=_n.length();h=this._clampDistance(d*this._scale);const m=d-h;this.object.position.addScaledVector(this._dollyDirection,m),this.object.updateMatrixWorld(),u=!!m}else if(this.object.isOrthographicCamera){const d=new J(this._mouse.x,this._mouse.y,0);d.unproject(this.object);const m=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),u=m!==this.object.zoom;const p=new J(this._mouse.x,this._mouse.y,0);p.unproject(this.object),this.object.position.sub(p).add(d),this.object.updateMatrixWorld(),h=_n.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;h!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(h).add(this.object.position):(Ku.origin.copy(this.object.position),Ku.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(Ku.direction))<XA?this.object.lookAt(this.target):(rv.setFromNormalAndCoplanarPoint(this.object.up,this.target),Ku.intersectPlane(rv,this.target))))}else if(this.object.isOrthographicCamera){const h=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),h!==this.object.zoom&&(this.object.updateProjectionMatrix(),u=!0)}return this._scale=1,this._performCursorZoom=!1,u||this._lastPosition.distanceToSquared(this.object.position)>ed||8*(1-this._lastQuaternion.dot(this.object.quaternion))>ed||this._lastTargetPosition.distanceToSquared(this.target)>ed?(this.dispatchEvent(sv),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(t){return t!==null?jn/60*this.autoRotateSpeed*t:jn/60/60*this.autoRotateSpeed}_getZoomScale(t){const i=Math.abs(t*.01);return Math.pow(.95,this.zoomSpeed*i)}_rotateLeft(t){this._sphericalDelta.theta-=t}_rotateUp(t){this._sphericalDelta.phi-=t}_panLeft(t,i){_n.setFromMatrixColumn(i,0),_n.multiplyScalar(-t),this._panOffset.add(_n)}_panUp(t,i){this.screenSpacePanning===!0?_n.setFromMatrixColumn(i,1):(_n.setFromMatrixColumn(i,0),_n.crossVectors(this.object.up,_n)),_n.multiplyScalar(t),this._panOffset.add(_n)}_pan(t,i){const s=this.domElement;if(this.object.isPerspectiveCamera){const l=this.object.position;_n.copy(l).sub(this.target);let u=_n.length();u*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*t*u/s.clientHeight,this.object.matrix),this._panUp(2*i*u/s.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(t*(this.object.right-this.object.left)/this.object.zoom/s.clientWidth,this.object.matrix),this._panUp(i*(this.object.top-this.object.bottom)/this.object.zoom/s.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(t,i){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const s=this.domElement.getBoundingClientRect(),l=t-s.left,u=i-s.top,h=s.width,d=s.height;this._mouse.x=l/h*2-1,this._mouse.y=-(u/d)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(t){return Math.max(this.minDistance,Math.min(this.maxDistance,t))}_handleMouseDownRotate(t){this._rotateStart.set(t.clientX,t.clientY)}_handleMouseDownDolly(t){this._updateZoomParameters(t.clientX,t.clientX),this._dollyStart.set(t.clientX,t.clientY)}_handleMouseDownPan(t){this._panStart.set(t.clientX,t.clientY)}_handleMouseMoveRotate(t){this._rotateEnd.set(t.clientX,t.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const i=this.domElement;this._rotateLeft(jn*this._rotateDelta.x/i.clientHeight),this._rotateUp(jn*this._rotateDelta.y/i.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(t){this._dollyEnd.set(t.clientX,t.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(t){this._panEnd.set(t.clientX,t.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(t){this._updateZoomParameters(t.clientX,t.clientY),t.deltaY<0?this._dollyIn(this._getZoomScale(t.deltaY)):t.deltaY>0&&this._dollyOut(this._getZoomScale(t.deltaY)),this.update()}_handleKeyDown(t){let i=!1;switch(t.code){case this.keys.UP:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(jn*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),i=!0;break;case this.keys.BOTTOM:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(-jn*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),i=!0;break;case this.keys.LEFT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(jn*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),i=!0;break;case this.keys.RIGHT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(-jn*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),i=!0;break}i&&(t.preventDefault(),this.update())}_handleTouchStartRotate(t){if(this._pointers.length===1)this._rotateStart.set(t.pageX,t.pageY);else{const i=this._getSecondPointerPosition(t),s=.5*(t.pageX+i.x),l=.5*(t.pageY+i.y);this._rotateStart.set(s,l)}}_handleTouchStartPan(t){if(this._pointers.length===1)this._panStart.set(t.pageX,t.pageY);else{const i=this._getSecondPointerPosition(t),s=.5*(t.pageX+i.x),l=.5*(t.pageY+i.y);this._panStart.set(s,l)}}_handleTouchStartDolly(t){const i=this._getSecondPointerPosition(t),s=t.pageX-i.x,l=t.pageY-i.y,u=Math.sqrt(s*s+l*l);this._dollyStart.set(0,u)}_handleTouchStartDollyPan(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enablePan&&this._handleTouchStartPan(t)}_handleTouchStartDollyRotate(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enableRotate&&this._handleTouchStartRotate(t)}_handleTouchMoveRotate(t){if(this._pointers.length==1)this._rotateEnd.set(t.pageX,t.pageY);else{const s=this._getSecondPointerPosition(t),l=.5*(t.pageX+s.x),u=.5*(t.pageY+s.y);this._rotateEnd.set(l,u)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const i=this.domElement;this._rotateLeft(jn*this._rotateDelta.x/i.clientHeight),this._rotateUp(jn*this._rotateDelta.y/i.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(t){if(this._pointers.length===1)this._panEnd.set(t.pageX,t.pageY);else{const i=this._getSecondPointerPosition(t),s=.5*(t.pageX+i.x),l=.5*(t.pageY+i.y);this._panEnd.set(s,l)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(t){const i=this._getSecondPointerPosition(t),s=t.pageX-i.x,l=t.pageY-i.y,u=Math.sqrt(s*s+l*l);this._dollyEnd.set(0,u),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const h=(t.pageX+i.x)*.5,d=(t.pageY+i.y)*.5;this._updateZoomParameters(h,d)}_handleTouchMoveDollyPan(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enablePan&&this._handleTouchMovePan(t)}_handleTouchMoveDollyRotate(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enableRotate&&this._handleTouchMoveRotate(t)}_addPointer(t){this._pointers.push(t.pointerId)}_removePointer(t){delete this._pointerPositions[t.pointerId];for(let i=0;i<this._pointers.length;i++)if(this._pointers[i]==t.pointerId){this._pointers.splice(i,1);return}}_isTrackingPointer(t){for(let i=0;i<this._pointers.length;i++)if(this._pointers[i]==t.pointerId)return!0;return!1}_trackPointer(t){let i=this._pointerPositions[t.pointerId];i===void 0&&(i=new ne,this._pointerPositions[t.pointerId]=i),i.set(t.pageX,t.pageY)}_getSecondPointerPosition(t){const i=t.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[i]}_customWheelEvent(t){const i=t.deltaMode,s={clientX:t.clientX,clientY:t.clientY,deltaY:t.deltaY};switch(i){case 1:s.deltaY*=16;break;case 2:s.deltaY*=100;break}return t.ctrlKey&&!this._controlActive&&(s.deltaY*=10),s}}function YA(r){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(r.pointerId),this.domElement.ownerDocument.addEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(r)&&(this._addPointer(r),r.pointerType==="touch"?this._onTouchStart(r):this._onMouseDown(r)))}function qA(r){this.enabled!==!1&&(r.pointerType==="touch"?this._onTouchMove(r):this._onMouseMove(r))}function jA(r){switch(this._removePointer(r),this._pointers.length){case 0:this.domElement.releasePointerCapture(r.pointerId),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(qv),this.state=We.NONE;break;case 1:const t=this._pointers[0],i=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:i.x,pageY:i.y});break}}function ZA(r){let t;switch(r.button){case 0:t=this.mouseButtons.LEFT;break;case 1:t=this.mouseButtons.MIDDLE;break;case 2:t=this.mouseButtons.RIGHT;break;default:t=-1}switch(t){case Vr.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(r),this.state=We.DOLLY;break;case Vr.ROTATE:if(r.ctrlKey||r.metaKey||r.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(r),this.state=We.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(r),this.state=We.ROTATE}break;case Vr.PAN:if(r.ctrlKey||r.metaKey||r.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(r),this.state=We.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(r),this.state=We.PAN}break;default:this.state=We.NONE}this.state!==We.NONE&&this.dispatchEvent(_p)}function KA(r){switch(this.state){case We.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(r);break;case We.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(r);break;case We.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(r);break}}function QA(r){this.enabled===!1||this.enableZoom===!1||this.state!==We.NONE||(r.preventDefault(),this.dispatchEvent(_p),this._handleMouseWheel(this._customWheelEvent(r)),this.dispatchEvent(qv))}function JA(r){this.enabled!==!1&&this._handleKeyDown(r)}function $A(r){switch(this._trackPointer(r),this._pointers.length){case 1:switch(this.touches.ONE){case Gr.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(r),this.state=We.TOUCH_ROTATE;break;case Gr.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(r),this.state=We.TOUCH_PAN;break;default:this.state=We.NONE}break;case 2:switch(this.touches.TWO){case Gr.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(r),this.state=We.TOUCH_DOLLY_PAN;break;case Gr.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(r),this.state=We.TOUCH_DOLLY_ROTATE;break;default:this.state=We.NONE}break;default:this.state=We.NONE}this.state!==We.NONE&&this.dispatchEvent(_p)}function tR(r){switch(this._trackPointer(r),this.state){case We.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(r),this.update();break;case We.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(r),this.update();break;case We.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(r),this.update();break;case We.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(r),this.update();break;default:this.state=We.NONE}}function eR(r){this.enabled!==!1&&r.preventDefault()}function nR(r){r.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function iR(r){r.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}var Is=Object.freeze({Linear:Object.freeze({None:function(r){return r},In:function(r){return this.None(r)},Out:function(r){return this.None(r)},InOut:function(r){return this.None(r)}}),Quadratic:Object.freeze({In:function(r){return r*r},Out:function(r){return r*(2-r)},InOut:function(r){return(r*=2)<1?.5*r*r:-.5*(--r*(r-2)-1)}}),Cubic:Object.freeze({In:function(r){return r*r*r},Out:function(r){return--r*r*r+1},InOut:function(r){return(r*=2)<1?.5*r*r*r:.5*((r-=2)*r*r+2)}}),Quartic:Object.freeze({In:function(r){return r*r*r*r},Out:function(r){return 1- --r*r*r*r},InOut:function(r){return(r*=2)<1?.5*r*r*r*r:-.5*((r-=2)*r*r*r-2)}}),Quintic:Object.freeze({In:function(r){return r*r*r*r*r},Out:function(r){return--r*r*r*r*r+1},InOut:function(r){return(r*=2)<1?.5*r*r*r*r*r:.5*((r-=2)*r*r*r*r+2)}}),Sinusoidal:Object.freeze({In:function(r){return 1-Math.sin((1-r)*Math.PI/2)},Out:function(r){return Math.sin(r*Math.PI/2)},InOut:function(r){return .5*(1-Math.sin(Math.PI*(.5-r)))}}),Exponential:Object.freeze({In:function(r){return r===0?0:Math.pow(1024,r-1)},Out:function(r){return r===1?1:1-Math.pow(2,-10*r)},InOut:function(r){return r===0?0:r===1?1:(r*=2)<1?.5*Math.pow(1024,r-1):.5*(-Math.pow(2,-10*(r-1))+2)}}),Circular:Object.freeze({In:function(r){return 1-Math.sqrt(1-r*r)},Out:function(r){return Math.sqrt(1- --r*r)},InOut:function(r){return(r*=2)<1?-.5*(Math.sqrt(1-r*r)-1):.5*(Math.sqrt(1-(r-=2)*r)+1)}}),Elastic:Object.freeze({In:function(r){return r===0?0:r===1?1:-Math.pow(2,10*(r-1))*Math.sin((r-1.1)*5*Math.PI)},Out:function(r){return r===0?0:r===1?1:Math.pow(2,-10*r)*Math.sin((r-.1)*5*Math.PI)+1},InOut:function(r){return r===0?0:r===1?1:(r*=2,r<1?-.5*Math.pow(2,10*(r-1))*Math.sin((r-1.1)*5*Math.PI):.5*Math.pow(2,-10*(r-1))*Math.sin((r-1.1)*5*Math.PI)+1)}}),Back:Object.freeze({In:function(r){var t=1.70158;return r===1?1:r*r*((t+1)*r-t)},Out:function(r){var t=1.70158;return r===0?0:--r*r*((t+1)*r+t)+1},InOut:function(r){var t=2.5949095;return(r*=2)<1?.5*(r*r*((t+1)*r-t)):.5*((r-=2)*r*((t+1)*r+t)+2)}}),Bounce:Object.freeze({In:function(r){return 1-Is.Bounce.Out(1-r)},Out:function(r){return r<1/2.75?7.5625*r*r:r<2/2.75?7.5625*(r-=1.5/2.75)*r+.75:r<2.5/2.75?7.5625*(r-=2.25/2.75)*r+.9375:7.5625*(r-=2.625/2.75)*r+.984375},InOut:function(r){return r<.5?Is.Bounce.In(r*2)*.5:Is.Bounce.Out(r*2-1)*.5+.5}}),generatePow:function(r){return r===void 0&&(r=4),r=r<Number.EPSILON?Number.EPSILON:r,r=r>1e4?1e4:r,{In:function(t){return Math.pow(t,r)},Out:function(t){return 1-Math.pow(1-t,r)},InOut:function(t){return t<.5?Math.pow(t*2,r)/2:(1-Math.pow(2-t*2,r))/2+.5}}}}),al=function(){return performance.now()},aR=(function(){function r(){this._tweens={},this._tweensAddedDuringUpdate={}}return r.prototype.getAll=function(){var t=this;return Object.keys(this._tweens).map(function(i){return t._tweens[i]})},r.prototype.removeAll=function(){this._tweens={}},r.prototype.add=function(t){this._tweens[t.getId()]=t,this._tweensAddedDuringUpdate[t.getId()]=t},r.prototype.remove=function(t){delete this._tweens[t.getId()],delete this._tweensAddedDuringUpdate[t.getId()]},r.prototype.update=function(t,i){t===void 0&&(t=al()),i===void 0&&(i=!1);var s=Object.keys(this._tweens);if(s.length===0)return!1;for(;s.length>0;){this._tweensAddedDuringUpdate={};for(var l=0;l<s.length;l++){var u=this._tweens[s[l]],h=!i;u&&u.update(t,h)===!1&&!i&&delete this._tweens[s[l]]}s=Object.keys(this._tweensAddedDuringUpdate)}return!0},r})(),$d={Linear:function(r,t){var i=r.length-1,s=i*t,l=Math.floor(s),u=$d.Utils.Linear;return t<0?u(r[0],r[1],s):t>1?u(r[i],r[i-1],i-s):u(r[l],r[l+1>i?i:l+1],s-l)},Utils:{Linear:function(r,t,i){return(t-r)*i+r}}},jv=(function(){function r(){}return r.nextId=function(){return r._nextId++},r._nextId=0,r})(),tp=new aR,ov=(function(){function r(t,i){i===void 0&&(i=tp),this._object=t,this._group=i,this._isPaused=!1,this._pauseStart=0,this._valuesStart={},this._valuesEnd={},this._valuesStartRepeat={},this._duration=1e3,this._isDynamic=!1,this._initialRepeat=0,this._repeat=0,this._yoyo=!1,this._isPlaying=!1,this._reversed=!1,this._delayTime=0,this._startTime=0,this._easingFunction=Is.Linear.None,this._interpolationFunction=$d.Linear,this._chainedTweens=[],this._onStartCallbackFired=!1,this._onEveryStartCallbackFired=!1,this._id=jv.nextId(),this._isChainStopped=!1,this._propertiesAreSetUp=!1,this._goToEnd=!1}return r.prototype.getId=function(){return this._id},r.prototype.isPlaying=function(){return this._isPlaying},r.prototype.isPaused=function(){return this._isPaused},r.prototype.getDuration=function(){return this._duration},r.prototype.to=function(t,i){if(i===void 0&&(i=1e3),this._isPlaying)throw new Error("Can not call Tween.to() while Tween is already started or paused. Stop the Tween first.");return this._valuesEnd=t,this._propertiesAreSetUp=!1,this._duration=i<0?0:i,this},r.prototype.duration=function(t){return t===void 0&&(t=1e3),this._duration=t<0?0:t,this},r.prototype.dynamic=function(t){return t===void 0&&(t=!1),this._isDynamic=t,this},r.prototype.start=function(t,i){if(t===void 0&&(t=al()),i===void 0&&(i=!1),this._isPlaying)return this;if(this._group&&this._group.add(this),this._repeat=this._initialRepeat,this._reversed){this._reversed=!1;for(var s in this._valuesStartRepeat)this._swapEndStartRepeatValues(s),this._valuesStart[s]=this._valuesStartRepeat[s]}if(this._isPlaying=!0,this._isPaused=!1,this._onStartCallbackFired=!1,this._onEveryStartCallbackFired=!1,this._isChainStopped=!1,this._startTime=t,this._startTime+=this._delayTime,!this._propertiesAreSetUp||i){if(this._propertiesAreSetUp=!0,!this._isDynamic){var l={};for(var u in this._valuesEnd)l[u]=this._valuesEnd[u];this._valuesEnd=l}this._setupProperties(this._object,this._valuesStart,this._valuesEnd,this._valuesStartRepeat,i)}return this},r.prototype.startFromCurrentValues=function(t){return this.start(t,!0)},r.prototype._setupProperties=function(t,i,s,l,u){for(var h in s){var d=t[h],m=Array.isArray(d),p=m?"array":typeof d,g=!m&&Array.isArray(s[h]);if(!(p==="undefined"||p==="function")){if(g){var _=s[h];if(_.length===0)continue;for(var S=[d],M=0,b=_.length;M<b;M+=1){var C=this._handleRelativeValue(d,_[M]);if(isNaN(C)){g=!1,console.warn("Found invalid interpolation list. Skipping.");break}S.push(C)}g&&(s[h]=S)}if((p==="object"||m)&&d&&!g){i[h]=m?[]:{};var y=d;for(var x in y)i[h][x]=y[x];l[h]=m?[]:{};var _=s[h];if(!this._isDynamic){var L={};for(var x in _)L[x]=_[x];s[h]=_=L}this._setupProperties(y,i[h],_,l[h],u)}else(typeof i[h]>"u"||u)&&(i[h]=d),m||(i[h]*=1),g?l[h]=s[h].slice().reverse():l[h]=i[h]||0}}},r.prototype.stop=function(){return this._isChainStopped||(this._isChainStopped=!0,this.stopChainedTweens()),this._isPlaying?(this._group&&this._group.remove(this),this._isPlaying=!1,this._isPaused=!1,this._onStopCallback&&this._onStopCallback(this._object),this):this},r.prototype.end=function(){return this._goToEnd=!0,this.update(1/0),this},r.prototype.pause=function(t){return t===void 0&&(t=al()),this._isPaused||!this._isPlaying?this:(this._isPaused=!0,this._pauseStart=t,this._group&&this._group.remove(this),this)},r.prototype.resume=function(t){return t===void 0&&(t=al()),!this._isPaused||!this._isPlaying?this:(this._isPaused=!1,this._startTime+=t-this._pauseStart,this._pauseStart=0,this._group&&this._group.add(this),this)},r.prototype.stopChainedTweens=function(){for(var t=0,i=this._chainedTweens.length;t<i;t++)this._chainedTweens[t].stop();return this},r.prototype.group=function(t){return t===void 0&&(t=tp),this._group=t,this},r.prototype.delay=function(t){return t===void 0&&(t=0),this._delayTime=t,this},r.prototype.repeat=function(t){return t===void 0&&(t=0),this._initialRepeat=t,this._repeat=t,this},r.prototype.repeatDelay=function(t){return this._repeatDelayTime=t,this},r.prototype.yoyo=function(t){return t===void 0&&(t=!1),this._yoyo=t,this},r.prototype.easing=function(t){return t===void 0&&(t=Is.Linear.None),this._easingFunction=t,this},r.prototype.interpolation=function(t){return t===void 0&&(t=$d.Linear),this._interpolationFunction=t,this},r.prototype.chain=function(){for(var t=[],i=0;i<arguments.length;i++)t[i]=arguments[i];return this._chainedTweens=t,this},r.prototype.onStart=function(t){return this._onStartCallback=t,this},r.prototype.onEveryStart=function(t){return this._onEveryStartCallback=t,this},r.prototype.onUpdate=function(t){return this._onUpdateCallback=t,this},r.prototype.onRepeat=function(t){return this._onRepeatCallback=t,this},r.prototype.onComplete=function(t){return this._onCompleteCallback=t,this},r.prototype.onStop=function(t){return this._onStopCallback=t,this},r.prototype.update=function(t,i){var s=this,l;if(t===void 0&&(t=al()),i===void 0&&(i=!0),this._isPaused)return!0;var u,h=this._startTime+this._duration;if(!this._goToEnd&&!this._isPlaying){if(t>h)return!1;i&&this.start(t,!0)}if(this._goToEnd=!1,t<this._startTime)return!0;this._onStartCallbackFired===!1&&(this._onStartCallback&&this._onStartCallback(this._object),this._onStartCallbackFired=!0),this._onEveryStartCallbackFired===!1&&(this._onEveryStartCallback&&this._onEveryStartCallback(this._object),this._onEveryStartCallbackFired=!0);var d=t-this._startTime,m=this._duration+((l=this._repeatDelayTime)!==null&&l!==void 0?l:this._delayTime),p=this._duration+this._repeat*m,g=function(){if(s._duration===0||d>p)return 1;var y=Math.trunc(d/m),x=d-y*m,L=Math.min(x/s._duration,1);return L===0&&d===s._duration?1:L},_=g(),S=this._easingFunction(_);if(this._updateProperties(this._object,this._valuesStart,this._valuesEnd,S),this._onUpdateCallback&&this._onUpdateCallback(this._object,_),this._duration===0||d>=this._duration)if(this._repeat>0){var M=Math.min(Math.trunc((d-this._duration)/m)+1,this._repeat);isFinite(this._repeat)&&(this._repeat-=M);for(u in this._valuesStartRepeat)!this._yoyo&&typeof this._valuesEnd[u]=="string"&&(this._valuesStartRepeat[u]=this._valuesStartRepeat[u]+parseFloat(this._valuesEnd[u])),this._yoyo&&this._swapEndStartRepeatValues(u),this._valuesStart[u]=this._valuesStartRepeat[u];return this._yoyo&&(this._reversed=!this._reversed),this._startTime+=m*M,this._onRepeatCallback&&this._onRepeatCallback(this._object),this._onEveryStartCallbackFired=!1,!0}else{this._onCompleteCallback&&this._onCompleteCallback(this._object);for(var b=0,C=this._chainedTweens.length;b<C;b++)this._chainedTweens[b].start(this._startTime+this._duration,!1);return this._isPlaying=!1,!1}return!0},r.prototype._updateProperties=function(t,i,s,l){for(var u in s)if(i[u]!==void 0){var h=i[u]||0,d=s[u],m=Array.isArray(t[u]),p=Array.isArray(d),g=!m&&p;g?t[u]=this._interpolationFunction(d,l):typeof d=="object"&&d?this._updateProperties(t[u],h,d,l):(d=this._handleRelativeValue(h,d),typeof d=="number"&&(t[u]=h+(d-h)*l))}},r.prototype._handleRelativeValue=function(t,i){return typeof i!="string"?i:i.charAt(0)==="+"||i.charAt(0)==="-"?t+parseFloat(i):parseFloat(i)},r.prototype._swapEndStartRepeatValues=function(t){var i=this._valuesStartRepeat[t],s=this._valuesEnd[t];typeof s=="string"?this._valuesStartRepeat[t]=this._valuesStartRepeat[t]+parseFloat(s):this._valuesStartRepeat[t]=this._valuesEnd[t],this._valuesEnd[t]=i},r})();jv.nextId;var ji=tp;ji.getAll.bind(ji);ji.removeAll.bind(ji);ji.add.bind(ji);ji.remove.bind(ji);var sR=ji.update.bind(ji);const rR=({entries:r,activeEntryId:t,currentTime:i,searchTerm:s="",onStarClick:l,onEmptySpaceClick:u,onSwipe:h,resetTrigger:d=0})=>{const m=le.useRef(null),p=le.useRef(null),g=le.useRef(new NM),_=le.useRef(null),S=le.useRef(null),M=le.useRef(null),b=le.useRef(new zs),C=le.useRef(new zs),y=le.useRef(1),x=le.useRef(1),[L,P]=le.useState(!1),[O,I]=le.useState(!1),F=le.useRef([]),z=le.useRef(0),$=le.useRef({}),R=w=>{if($.current[w])return $.current[w];const B=document.createElement("canvas");B.width=128,B.height=128;const K=B.getContext("2d"),Z=K.createRadialGradient(64,64,0,64,64,64);Z.addColorStop(0,"white"),Z.addColorStop(.2,w),Z.addColorStop(1,"rgba(0,0,0,0)"),K.fillStyle=Z,K.fillRect(0,0,128,128);const ct=new HM(B);return $.current[w]=ct,ct};return le.useEffect(()=>{if(!m.current)return;const w=new vi(55,window.innerWidth/window.innerHeight,1,5e4);w.position.set(0,800,3e3),_.current=w;const B=new kA({antialias:!0,alpha:!0});B.setSize(window.innerWidth,window.innerHeight),B.setPixelRatio(Math.min(window.devicePixelRatio,2)),m.current.appendChild(B.domElement),S.current=B;const K=new WA(w,B.domElement);K.enableDamping=!0,M.current=K,g.current.add(b.current),b.current.add(C.current);const Z=new si,ct=new Float32Array(5e3*3);for(let G=0;G<5e3*3;G++)ct[G]=(Math.random()-.5)*1e4;Z.setAttribute("position",new yi(ct,3));const it=new BM(Z,new Bv({size:4,color:5195493,transparent:!0,opacity:.5,blending:ic}));b.current.add(it);const N=G=>{sR(G),K.update(),y.current+=(x.current-y.current)*.1,C.current.scale.setScalar(y.current),b.current.rotation.y+=1e-4,B.render(g.current,w),requestAnimationFrame(N)};return N(0),()=>{B.dispose()}},[]),le.useEffect(()=>{if(!C.current)return;C.current.clear(),r.filter(B=>B.timestamp<=i&&(!s||B.text.toLowerCase().includes(s.toLowerCase()))).forEach(B=>{const K=new zs;K.name=B.id,K.position.set(B.x,B.y,B.z);const Z=t===B.id,ct=new OM(new zv({map:R(B.moodColor),transparent:!0,opacity:Z?1:.7,blending:ic}));ct.scale.setScalar(Z?180:70),K.add(ct),K.add(new Yi(new mp(100,8,8),new pp({visible:!1}))),C.current.add(K)})},[r,i,t,s]),le.useEffect(()=>{if(!p.current)return;const w=window;if(!w.Hands||!w.Camera)return;const B=new w.Hands({locateFile:Z=>`https://cdn.jsdelivr.net/npm/@mediapipe/hands@0.4.1646424915/${Z}`});B.setOptions({maxNumHands:2,modelComplexity:1,minDetectionConfidence:.5,minTrackingConfidence:.5}),B.onResults(Z=>{P(!0);let ct=!1;Z.multiHandLandmarks&&Z.multiHandLandmarks.forEach((it,N)=>{if(Z.multiHandedness[N].label==="Left"){ct=!0;const tt=Date.now(),yt=it[8].x;if(F.current.push({x:yt,t:tt}),F.current.length>5&&tt>z.current){const xt=F.current[F.current.length-1].x-F.current[0].x;Math.abs(xt)>.15&&(h(xt<0?"right":"left"),z.current=tt+800,F.current=[])}}else{const tt=Math.sqrt(Math.pow(it[4].x-it[8].x,2)+Math.pow(it[4].y-it[8].y,2));x.current=Rv.mapLinear(tt,.05,.35,.4,4.5)}}),I(ct)});const K=new w.Camera(p.current,{onFrame:async()=>{p.current&&await B.send({image:p.current})},width:640,height:480});return K.start(),()=>{K.stop(),B.close()}},[h]),le.useEffect(()=>{d>0&&_.current&&M.current&&(new ov(_.current.position).to({x:0,y:800,z:3e3},1500).easing(Is.Quadratic.Out).start(),new ov(M.current.target).to({x:0,y:0,z:0},1500).easing(Is.Quadratic.Out).start())},[d]),Ct.jsxs(Ct.Fragment,{children:[Ct.jsx("video",{ref:p,className:"fixed bottom-4 right-4 w-40 h-30 rounded-xl opacity-20 grayscale border border-white/10 scale-x-[-1] z-[100]",autoPlay:!0,playsInline:!0,muted:!0}),Ct.jsxs("div",{className:"fixed inset-0 pointer-events-none z-[999]",children:[!L&&Ct.jsx("div",{className:"absolute top-1/2 left-1/2 -translate-x-1/2 text-white/20 text-[10px] tracking-[0.5em] animate-pulse",children:"INITIATING DIMENSIONAL SENSORS..."}),O&&Ct.jsx("div",{className:"absolute top-12 right-12 text-indigo-400 text-[10px] tracking-widest animate-pulse",children:"SWIPE TO NAVIGATE"})]}),Ct.jsx("div",{ref:m,className:"w-full h-full",onClick:w=>{const B=m.current.getBoundingClientRect(),K=new ne((w.clientX-B.left)/B.width*2-1,-((w.clientY-B.top)/B.height)*2+1),Z=new YM;Z.setFromCamera(K,_.current);const ct=Z.intersectObjects(C.current.children,!0);if(ct.length>0){let it=ct[0].object;for(;it.parent&&it.parent!==C.current;)it=it.parent;l(it.name)}else{const it=new J(K.x,K.y,.5).unproject(_.current),N=_.current.position.clone().add(it.sub(_.current.position).normalize().multiplyScalar(2e3));u(N.x,N.y,N.z,w.clientX,w.clientY)}}})]})},lv="my_galaxy_diary_v2",oR="0921",nd=[{hex:"#FFD700",label:"快乐"},{hex:"#4B0082",label:"忧郁"},{hex:"#00FA9A",label:"平静"},{hex:"#FF4500",label:"热情"},{hex:"#9370DB",label:"迷茫"},{hex:"#F8F8FF",label:"观察"}],lR=()=>{const[r,t]=le.useState(!1),[i,s]=le.useState(""),[l,u]=le.useState(!1),[h,d]=le.useState(()=>{try{const W=localStorage.getItem(lv);return W?JSON.parse(W):[]}catch{return[]}}),[m,p]=le.useState(null),[g,_]=le.useState(!1),[S,M]=le.useState(!1),[b,C]=le.useState(null),[y,x]=le.useState(""),[L,P]=le.useState([]),[O,I]=le.useState(nd[0].hex),[F,z]=le.useState(""),[$,R]=le.useState(!1),[w,B]=le.useState(0),K=le.useRef(null),[Z,ct]=le.useState(!1),it=le.useMemo(()=>[...h].sort((W,vt)=>W.timestamp-vt.timestamp),[h]),N=le.useMemo(()=>{if(it.length===0)return{min:Date.now()-864e5,max:Date.now()};const W=it[0].timestamp-36e5,vt=it[it.length-1].timestamp+1e3;return{min:W,max:vt}},[it]),[G,tt]=le.useState(N.max);le.useEffect(()=>{tt(N.max)},[h.length,N.max]);const yt=W=>{i===oR?t(!0):(u(!0),setTimeout(()=>u(!1),500),s(""))},xt=le.useCallback(W=>{if(!r)return;const vt=h.find(Ut=>Ut.id===W);vt&&(p(vt),_(!1))},[h,r]),U=le.useCallback((W,vt,Ut,Ot,ce)=>{!r||m||(C({wx:W,wy:vt,wz:Ut,sx:Ot,sy:ce}),_(!0),x(""),P([]),I(nd[0].hex))},[m,r]),st=le.useCallback(W=>{if(!r||it.length===0)return;let vt=-1;if(!m)vt=W==="right"?0:it.length-1;else{const Ut=it.findIndex(Ot=>Ot.id===m.id);W==="right"?vt=Math.min(it.length-1,Ut+1):vt=Math.max(0,Ut-1)}if(vt!==-1){const Ut=it[vt];p(Ut),tt(Ut.timestamp)}},[m,it,r]),mt=W=>{const vt=W.target.files;vt&&Array.from(vt).forEach(Ut=>{const Ot=new FileReader;Ot.onloadend=()=>{P(ce=>[...ce,Ot.result].slice(-3))},Ot.readAsDataURL(Ut)})},At=W=>{P(vt=>vt.filter((Ut,Ot)=>Ot!==W))},Ht=async()=>{if(!y.trim()||!b)return;M(!0);const W={id:`mem-${Date.now()}`,x:b.wx,y:b.wy,z:b.wz,text:y,images:L,moodColor:O,timestamp:Date.now()};await new Promise(Ut=>setTimeout(Ut,800));const vt=[...h,W];localStorage.setItem(lv,JSON.stringify(vt)),d(vt),M(!1),_(!1)},at=W=>new Intl.DateTimeFormat("zh-CN",{month:"long",year:"numeric",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(W));return Ct.jsxs("div",{className:"relative w-full h-screen overflow-hidden select-none bg-[#020205]",children:[Ct.jsx("div",{className:`absolute inset-0 z-0 transition-all duration-1000 ${m||g||!r?"opacity-30 blur-[20px] scale-105":"opacity-100 blur-0 scale-100"}`,children:Ct.jsx(rR,{entries:h,activeEntryId:(m==null?void 0:m.id)||null,currentTime:G,searchTerm:F,onStarClick:xt,onEmptySpaceClick:U,onSwipe:st,resetTrigger:w})}),Ct.jsxs("div",{className:`absolute top-12 right-12 z-[100] flex items-center gap-6 transition-all duration-700 ${!r||m||g?"opacity-0 -translate-y-5 pointer-events-none":"opacity-100 pointer-events-auto"}`,children:[Ct.jsx("button",{onClick:W=>{W.stopPropagation(),B(vt=>vt+1)},className:"w-10 h-10 glass-card rounded-full flex items-center justify-center text-white/40 hover:text-white transition-all pointer-events-auto",children:Ct.jsx("svg",{className:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:Ct.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z"})})}),Ct.jsxs("div",{className:`flex items-center glass-card rounded-full overflow-hidden transition-all duration-500 pointer-events-auto ${$?"w-64 px-4":"w-10 px-0"}`,children:[Ct.jsx("button",{onClick:W=>{W.stopPropagation(),R(!$)},className:"w-10 h-10 flex-shrink-0 flex items-center justify-center text-white/40 hover:text-white",children:Ct.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:Ct.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"})})}),Ct.jsx("input",{type:"text",placeholder:"搜索记忆...",value:F,onKeyDown:W=>W.stopPropagation(),onChange:W=>z(W.target.value),className:"bg-transparent border-none outline-none text-[10px] text-white/80 tracking-widest uppercase w-full ml-2 placeholder:text-white/20"})]})]}),Ct.jsx("div",{className:`absolute bottom-12 left-1/2 -translate-x-1/2 z-50 w-full max-w-2xl px-12 transition-all duration-1000 ${!r||m||g?"opacity-0 translate-y-12 pointer-events-none":"opacity-100"}`,children:Ct.jsxs("div",{className:`glass-card p-8 rounded-[2.5rem] flex flex-col gap-3 relative overflow-hidden transition-all duration-500 ${Z?"timeline-dragging scale-105":""}`,children:[Z&&Ct.jsxs(Ct.Fragment,{children:[Ct.jsx("div",{className:"streak top-1/4 left-10",style:{animationDelay:"0s"}}),Ct.jsx("div",{className:"streak top-2/4 right-20",style:{animationDelay:"0.5s"}}),Ct.jsx("div",{className:"streak bottom-1/4 left-40",style:{animationDelay:"1s"}})]}),Ct.jsxs("div",{className:"flex justify-between items-center mb-2 px-2",children:[Ct.jsx("span",{className:"text-[9px] tracking-[0.5em] text-white/20 uppercase font-light",children:"Memory Chrono"}),Ct.jsx("div",{className:`text-center transition-all duration-300 ${Z?"scale-125 text-indigo-300 drop-shadow-[0_0_10px_rgba(165,180,252,0.8)]":"text-white/60"}`,children:Ct.jsx("span",{className:"text-[10px] tracking-[0.3em] uppercase font-mono",children:at(G)})}),Ct.jsx("span",{className:"text-[9px] tracking-[0.5em] text-white/20 uppercase font-light",children:"Origin Axis"})]}),Ct.jsxs("div",{className:"relative flex items-center h-4",children:[Ct.jsx("div",{className:"absolute inset-0 rounded-full timeline-track opacity-50"}),Ct.jsx("input",{type:"range",min:N.min,max:N.max,value:G,onMouseDown:()=>ct(!0),onMouseUp:()=>ct(!1),onTouchStart:()=>ct(!0),onTouchEnd:()=>ct(!1),onChange:W=>tt(Number(W.target.value)),className:"relative w-full h-1 bg-transparent appearance-none cursor-pointer z-10"})]}),Ct.jsxs("div",{className:"flex justify-between text-[7px] tracking-[0.2em] text-white/10 uppercase px-2 mt-1",children:[Ct.jsx("span",{children:at(N.min).split(" ")[0]}),Ct.jsx("span",{children:"Current Space-Time"}),Ct.jsx("span",{children:at(N.max).split(" ")[0]})]})]})}),m&&Ct.jsx("div",{className:"absolute inset-0 z-[100] flex items-center justify-center p-6 bg-black/40 backdrop-blur-sm animate-entrance",onClick:()=>p(null),children:Ct.jsxs("div",{className:"max-w-4xl w-full p-12 md:p-20 rounded-[3rem] glass-card relative pointer-events-auto",onClick:W=>W.stopPropagation(),children:[Ct.jsx("div",{className:"absolute top-0 left-0 w-full h-1",style:{background:m.moodColor}}),Ct.jsx("button",{onClick:()=>p(null),className:"absolute top-8 right-8 text-white/20 hover:text-white text-4xl font-thin transition-colors",children:"×"}),Ct.jsxs("div",{className:"text-center mb-10",children:[Ct.jsx("div",{className:"inline-block px-4 py-1 rounded-full border border-white/10 text-[10px] tracking-[0.4em] text-white/40 uppercase mb-4",children:"Memory Resonated"}),Ct.jsx("h3",{className:"text-xs font-mono text-white/40 tracking-widest uppercase",children:at(m.timestamp)})]}),Ct.jsxs("div",{className:"max-h-[60vh] overflow-y-auto pr-4 scrollbar-hide text-center",children:[Ct.jsx("p",{className:"text-2xl md:text-3xl font-extralight text-white/90 leading-relaxed tracking-wide mb-8",children:m.text}),m.images&&m.images.length>0&&Ct.jsx("div",{className:"flex flex-wrap justify-center gap-4",children:m.images.map((W,vt)=>Ct.jsx("img",{src:W,alt:"Memory",className:"w-full max-w-md rounded-2xl object-cover shadow-2xl border border-white/10"},vt))})]}),Ct.jsxs("div",{className:"mt-12 flex flex-col items-center",children:[Ct.jsx("div",{className:"w-12 h-[1px] bg-white/10 mb-8"}),Ct.jsx("button",{onClick:()=>p(null),className:"px-10 py-4 rounded-full border border-white/10 text-[10px] tracking-[0.5em] text-white/40 uppercase hover:bg-white/5 transition-all",children:"收回思绪"})]})]})}),g&&b&&Ct.jsx("div",{className:"absolute inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm animate-entrance",onClick:()=>_(!1),children:Ct.jsxs("div",{className:"w-[520px] p-10 rounded-[3rem] glass-card pointer-events-auto border-white/5 shadow-2xl",onClick:W=>W.stopPropagation(),children:[Ct.jsxs("div",{className:"flex justify-between items-center mb-8",children:[Ct.jsx("h2",{className:"text-[10px] tracking-[0.5em] text-white/30 uppercase font-light",children:"正在将记忆刻入星系"}),Ct.jsx("button",{onClick:()=>_(!1),className:"text-white/20 hover:text-white/60 transition-colors",children:"×"})]}),Ct.jsx("div",{className:"flex gap-4 mb-10 justify-start",children:nd.map(W=>Ct.jsx("button",{onClick:()=>I(W.hex),className:`w-10 h-10 rounded-full transition-all duration-300 relative ${O===W.hex?"scale-110 shadow-[0_0_20px_rgba(255,255,255,0.3)]":"opacity-40 grayscale-[40%]"}`,style:{backgroundColor:W.hex},children:O===W.hex&&Ct.jsx("div",{className:"absolute inset-0 rounded-full border-2 border-white animate-ping opacity-20"})},W.hex))}),Ct.jsxs("div",{className:"relative mb-6",children:[Ct.jsx("textarea",{autoFocus:!0,className:"w-full bg-transparent border-none outline-none text-white/90 text-xl font-light h-48 resize-none mb-2 placeholder:text-white/10 leading-relaxed",placeholder:"此时此刻的想法...",value:y,onChange:W=>x(W.target.value)}),Ct.jsxs("div",{className:"flex gap-3 mt-4 flex-wrap",children:[L.map((W,vt)=>Ct.jsxs("div",{className:"relative group w-20 h-20 rounded-xl overflow-hidden border border-white/10",children:[Ct.jsx("img",{src:W,className:"w-full h-full object-cover"}),Ct.jsx("button",{onClick:()=>At(vt),className:"absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 flex items-center justify-center text-white text-xs transition-opacity",children:"移除"})]},vt)),L.length<3&&Ct.jsxs("button",{onClick:()=>{var W;return(W=K.current)==null?void 0:W.click()},className:"w-20 h-20 rounded-xl border-2 border-dashed border-white/10 flex flex-col items-center justify-center text-white/20 hover:text-white/40 hover:border-white/20 transition-all gap-1",children:[Ct.jsx("svg",{className:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:Ct.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M12 4v16m8-8H4"})}),Ct.jsx("span",{className:"text-[8px] uppercase tracking-tighter",children:"添加图片"})]}),Ct.jsx("input",{ref:K,type:"file",accept:"image/*",multiple:!0,className:"hidden",onChange:mt})]})]}),Ct.jsx("div",{className:"flex justify-between items-center mb-8 px-1",children:Ct.jsx("button",{className:"px-4 py-1.5 rounded-lg bg-white/5 text-[9px] text-white/30 uppercase tracking-[0.2em] border border-white/5 hover:bg-white/10 transition-all",children:"Preview"})}),Ct.jsx("button",{onClick:Ht,disabled:S||!y.trim(),className:`w-full py-5 rounded-3xl transition-all duration-500 text-[10px] text-white tracking-[0.5em] uppercase border ${S||!y.trim()?"bg-transparent border-white/5 text-white/10 cursor-not-allowed":"bg-white/5 hover:bg-white/10 border-white/10 hover:shadow-[0_0_40px_rgba(255,255,255,0.05)]"}`,children:S?"正在镌刻星纹...":"点亮这颗星"})]})}),!r&&Ct.jsx("div",{className:"absolute inset-0 z-[200] flex items-center justify-center bg-[#020205] p-6 animate-entrance",children:Ct.jsxs("div",{className:`glass-card p-12 rounded-[4rem] w-full max-w-sm flex flex-col items-center ${l?"shake":""}`,children:[Ct.jsx("h2",{className:"text-xl font-extralight tracking-[0.5em] text-white/80 mb-12 uppercase",children:"星系权限验证"}),Ct.jsx("input",{autoFocus:!0,type:"password",maxLength:4,placeholder:"密码",value:i,onChange:W=>s(W.target.value),onKeyDown:W=>W.key==="Enter"&&yt(),className:"w-full bg-white/5 border border-white/10 rounded-3xl py-6 text-center text-2xl text-white tracking-[1em] outline-none mb-8"}),Ct.jsx("button",{onClick:()=>yt(),className:"w-full py-4 rounded-full border border-white/10 text-[10px] text-white/40 tracking-[0.5em] uppercase hover:bg-white/5",children:"开启接入"})]})}),Ct.jsxs("div",{className:`absolute top-12 left-12 z-10 pointer-events-none transition-all duration-1000 ${!r||m||g?"opacity-20 blur-sm":"opacity-100"}`,children:[Ct.jsx("h1",{className:"text-5xl font-extralight tracking-[0.6em] text-white/90 drop-shadow-2xl",children:"星系日记"}),Ct.jsxs("p",{className:"text-[10px] tracking-[0.5em] text-indigo-400/60 mt-4 uppercase",children:["Galaxy Diary • ",h.length," 颗记忆星辰"]})]})]})},Zv=document.getElementById("root");if(!Zv)throw new Error("Could not find root element to mount to");const uR=fy.createRoot(Zv);uR.render(Ct.jsx(iy.StrictMode,{children:Ct.jsx(lR,{})}));
